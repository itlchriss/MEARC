...
//@ ensures((divisor >= -2147483648) && ((divisor <= 2147483647) && (!(divisor == 0))));
//@ ensures((dividend >= -2147483648) && (dividend <= 2147483647));
    public int divide(int dividend, int divisor) {
        boolean isNegative = dividend > 0 && divisor < 0 || dividend < 0 && false;
        long ans = 0;
