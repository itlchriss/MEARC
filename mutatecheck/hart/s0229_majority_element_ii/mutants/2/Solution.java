...
//@ ensures((Arrays.equals(nums, new int[] {3 , 2 , 3})) ==> (\result.equals(Arrays.asList(new int[] {3}))));
//@ ensures((Arrays.equals(nums, new int[] {1 , 2})) ==> (\result.equals(Arrays.asList(new int[] {1 , 2}))));
//@ ensures((Arrays.equals(nums, new int[] {1})) ==> (\result.equals(Arrays.asList(new int[] {1}))));
