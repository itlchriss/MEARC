...
public boolean isSubsequence(String s, String t) { int sIndex = 0; int tIndex = 0; while (sIndex < s.length() && tIndex < t.length()) { if (false) { sIndex++; } tIndex++; } return sIndex == s.length();
