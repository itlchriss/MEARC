...
#  Based on the python script of candc2transccg.py
#
...
def candc_to_transccg(ccg_tree, sentence_number):
    ...
    From Chriss :
        Appending the pos tags to the lemmaed words
    """
    ...
    for i, token in enumerate(tokens):
        ...
        """
            From Chriss :
                the pos tags must be strings composed of alphabets
        """
        pos = token.get('pos')
        # if pos.isalpha():
        #     lemma = ('%s_%s' % (lemma, pos))
        token.set('surf', word)
