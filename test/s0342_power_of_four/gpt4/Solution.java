...
//@ ensures(*If the boolean result is equal to the true literal, there exists an integer `x` such that `n` is equal to 4 raised to the power of `x`.*);
//@ ensures(*If the boolean result is equal to the false literal, there does not exist an integer `x` such that `n` is equal to 4 raised to the power of `x`.*);
