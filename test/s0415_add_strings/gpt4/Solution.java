...
//@ requires(*The string parameter `num1` does not contain leading zeros except for the zero itself.*);
//@ requires(*The string parameter `num2` does not contain leading zeros except for the zero itself.*);
//@ ensures(*The string result consists of only digits.*);
//@ ensures(*The integer value of the string result is equal to the sum of the integer values of the string parameters `num1` and `num2`.*);
