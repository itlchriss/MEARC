...
//@ ensures(*If the boolean result is equal to the true literal, all characters in the string parameter `s` appear in the string parameter `t` in the same order.*);
//@ ensures(*If the boolean result is equal to the false literal, not all characters in the string parameter `s` appear in the string parameter `t` in the same order.*);
