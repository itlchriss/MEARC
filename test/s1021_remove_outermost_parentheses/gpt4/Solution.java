...
//@ ensures(*The string result does not contain any outermost parentheses of any primitive valid parentheses string in the primitive decomposition of the string parameter `s`.*);
