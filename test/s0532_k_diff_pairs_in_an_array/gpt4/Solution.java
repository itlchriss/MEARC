...
//@ requires(*All values in the integer array parameter `nums` are less than or equal to 10000000 and are greater than or equal to -10000000.*);
...
//@ ensures(*If the integer parameter `k` is equal to 0, the integer result is equal to the number of unique elements in the integer array parameter `nums` that appear more than once.*);
