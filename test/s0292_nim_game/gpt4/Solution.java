...
//@ ensures(*If the integer result is equal to the true literal, the integer parameter `n` mod 4 is not equal to 0.*);
//@ ensures(*If the integer result is equal to the false literal, the integer parameter `n` mod 4 is equal to 0.*);
