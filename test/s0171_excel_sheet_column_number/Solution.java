...
//@ requires(*The length of the string parameter `columnTitle` is less than or equal to 7 and is greater than or equal to 1.*);
//@ requires(*The string parameter `columnTitle` consists only of uppercase English letters.*);
//@ requires(*The string parameter `columnTitle` is in the range ["A", "FXSHRXW"].*);
//@ ensures(*The integer result is less than or equal to 2147483647 and is greater than or equal to 1.*);
