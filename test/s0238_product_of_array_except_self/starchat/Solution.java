...
//@ ensures(*The integer array result should have the same length as the input array parameter `nums`.*);
//@ ensures(*The integer array result should not contain any division operation.*);
//@ ensures(*The integer array result should be calculated in O(n) time complexity.*);
//@ ensures(*The integer array result should not use any extra space complexity.*);
