...
//@ ensures(*The integer result is greater than or equal to 0 and is less than 2^31.*);
...
//@ ensures(*The binary representation of the integer result is the complement of the binary representation of the integer parameter `num`.*);
