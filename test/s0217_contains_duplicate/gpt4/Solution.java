...
//@ ensures(*If the boolean result is equal to the true literal, there exists at least one integer value in the integer array parameter `nums` that appears more than once.*);
//@ ensures(*If the boolean result is equal to the false literal, all integer values in the integer array parameter `nums` are unique.*);
