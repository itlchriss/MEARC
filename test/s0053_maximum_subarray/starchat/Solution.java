...
//@ ensures(*The integer result is greater than or equal to the smallest possible sum of a contiguous subarray and is less than or equal to the largest possible sum of a contiguous subarray.*);
