...
public class Solution {
	...
	//@ requires(*The elements in the input array `arr` are non-negative integers.*);
	//@ ensures(*The method returns an integer representing the number of good starting indices.*);
