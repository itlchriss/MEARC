...
public class Solution {
	...
	//@ requires(*3. The input matrix must be a square matrix (number of rows = number of columns).*);
	//@ requires(*4. The values in the input matrix must be within the range of -100 to 100.*);
