...
public class Solution {
	...
	//@ requires(*The length of the input `edges` is equal to `n - 1`.*);
	//@ requires(*Each element in the input `edges` is a 2-element array.*);
	//@ requires(*The values in the input `edges` are valid node labels within the range of `0` to `n - 1`.*);
	//@ requires(*The length of the input `values` is equal to `n`.*);
	//@ requires(*Each element in the input `values` is a non-negative integer.*);
	//@ requires(*The input `k` is a positive integer.*);
	//@ requires(*The sum of the values in the input `values` is divisible by `k`.*);
	//@ requires(*The input `edges` represents a valid tree.*);
