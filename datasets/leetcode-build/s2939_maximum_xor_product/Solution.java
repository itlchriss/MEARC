...
public class Solution {
	//@ requires(*The input integers `a` and `b` must be non-negative and less than 2^50.*);
	//@ requires(*The input integer `n` must be non-negative and less than or equal to 50.*);
