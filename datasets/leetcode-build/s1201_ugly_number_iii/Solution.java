...
public class Solution {
	...
	//@ requires(*The input integers `n`, `a`, `b`, and `c` must be positive.*);
	//@ requires(*The input integers `a`, `b`, and `c` must be greater than or equal to 1.*);
	//@ requires(*The input integers `a`, `b`, and `c` must be less than or equal to 10^9.*);
	//@ requires(*The product of `a`, `b`, and `c` must be greater than or equal to 1.*);
	//@ requires(*The product of `a`, `b`, and `c` must be less than or equal to 10^18.*);
