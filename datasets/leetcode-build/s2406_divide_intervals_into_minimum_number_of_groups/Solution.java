...
public class Solution {
	//@ requires(*The input `intervals` is a 2D integer array.*);
	//@ requires(*Each element in `intervals` is an array of length 2.*);
	//@ requires(*The first element of each interval is less than or equal to the second element.*);
	//@ requires(*The length of `intervals` is between 1 and 10^5.*);
