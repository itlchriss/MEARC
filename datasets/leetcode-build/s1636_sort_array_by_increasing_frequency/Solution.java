...
public class Solution {
	...
	//@ requires(*The elements in the input array `nums` are within the range of -100 to 100.*);
	//@ ensures(*The output array is not null.*);
	//@ ensures(*The length of the output array is the same as the input array.*);
	//@ ensures(*The elements in the output array are sorted in increasing order based on their frequency.*);
	//@ ensures(*If multiple elements have the same frequency, they are sorted in decreasing order.*);
