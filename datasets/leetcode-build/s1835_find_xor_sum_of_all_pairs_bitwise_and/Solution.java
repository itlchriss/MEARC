...
public class Solution {
	//@ requires(*The input arrays `arr1` and `arr2` must not be null.*);
	//@ requires(*The lengths of `arr1` and `arr2` must be greater than or equal to 1.*);
	//@ requires(*The elements of `arr1` and `arr2` must be non-negative integers.*);
