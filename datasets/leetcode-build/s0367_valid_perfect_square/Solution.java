...
public class Solution {
	...
	//@ requires(*The input `num` must be within the range of `1` to `2^31 - 1`.*);
	//@ ensures(*The method should return `true` if `num` is a perfect square.*);
	//@ ensures(*The method should return `false` if `num` is not a perfect square.*);
