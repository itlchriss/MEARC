...
public class Solution {
	//@ requires(*The length of `nums1` and `nums2` should be equal.*);
	//@ requires(*`nums1` and `nums2` should have a length greater than or equal to - The values in `nums1` and `nums2` should be integers.*);
	//@ requires(*The values in `nums1` and `nums2` should be between 1 and `n`, inclusive.*);
