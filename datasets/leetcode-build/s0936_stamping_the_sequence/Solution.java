...
public class Solution {
	//@ requires(*The length of `stamp` is at least 1 and at most the length of `target`.*);
	//@ requires(*The length of `target` is at least 1 and at most 1000.*);
	//@ requires(*`stamp` and `target` consist of lowercase English letters.*);
