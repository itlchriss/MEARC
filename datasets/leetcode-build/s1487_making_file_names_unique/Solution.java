...
public class Solution {
	//@ requires(*The input array `names` is not null.*);
	//@ requires(*The length of the input array `names` is greater than 0.*);
	//@ requires(*Each element in the input array `names` is not null.*);
	//@ requires(*Each element in the input array `names` is a string of lowercase English letters, digits, and/or round brackets.*);
	//@ requires(*The length of each element in the input array `names` is greater than 0 and less than or equal to 20.*);
