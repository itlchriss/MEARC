...
public class Solution {
	//@ requires(*The input integer `n` is non-negative (0 <= n <= 10^9).*);
	//@ ensures(*The returned string represents the binary representation of `n` in base -2.*);
	//@ ensures(*The returned string does not have leading zeros, unless the string is "0".*);
