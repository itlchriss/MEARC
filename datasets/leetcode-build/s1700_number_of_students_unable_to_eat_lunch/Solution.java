...
public class Solution {
	//@ requires(*The length of the `students` array is equal to the length of the `sandwiches` array.*);
	//@ requires(*The elements in the `students` array are either 0 or 1.*);
	//@ requires(*The elements in the `sandwiches` array are either 0 or 1.*);
