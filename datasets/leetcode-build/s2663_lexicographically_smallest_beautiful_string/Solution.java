...
public class Solution {
	...
	//@ requires(*The length of the input string `s` is equal to `n`.*);
	//@ requires(*The value of `k` is a positive integer.*);
	//@ requires(*The value of `k` is between 4 and 26 (inclusive).*);
	//@ requires(*The input string `s` is a beautiful string.*);
