...
public class Solution {
	//@ requires(*The input `bank` is not null.*);
	//@ requires(*The length of `bank` is greater than 0.*);
	//@ requires(*The length of each string in `bank` is greater than 0.*);
	//@ requires(*The characters in each string of `bank` are either '0' or '1'.*);
