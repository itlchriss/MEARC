...
public class Solution {
    private long[][] g;
	//@ requires(*The length of string `s` and string `t` must be equal.*);
	//@ requires(*The length of string `s` must be greater than 2.*);
	//@ requires(*The value of `k` must be greater than or equal to 1.*);
	//@ requires(*The strings `s` and `t` must consist of only lowercase English alphabets.*);
