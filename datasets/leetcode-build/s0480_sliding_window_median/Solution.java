...
public class Solution {
	...
	//@ ensures(*The output array `medianArray` is not null.*);
	//@ ensures(*The length of the output array `medianArray` is equal to `nums.length - k + 1`.*);
	//@ ensures(*Each element in the output array `medianArray` is a double value.*);
	//@ ensures(*The elements in the output array `medianArray` are the medians of the sliding windows in the original array `nums`.*);
