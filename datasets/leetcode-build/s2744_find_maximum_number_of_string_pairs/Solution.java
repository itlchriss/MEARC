...
public class Solution {
	...
	//@ requires(*The length of the input array `words` is at least 1 and at most 50.*);
	//@ requires(*Each string in the input array `words` has a length of 2.*);
	//@ requires(*The strings in the input array `words` are distinct.*);
	//@ requires(*Each string in the input array `words` contains only lowercase English letters.*);
