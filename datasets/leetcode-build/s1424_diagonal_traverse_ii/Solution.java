...
public class Solution {
	//@ requires(*The input `nums` is a 2D integer array.*);
	//@ requires(*The length of `nums` is greater than or equal to 1 and less than or equal to 100,Each element in `nums` is a list of integers.*);
	//@ requires(*The length of each list in `nums` is greater than or equal to 1 and less than or equal to 100,The sum of the lengths of all lists in `nums` is greater than or equal to 1 and less than or equal to 100,Each element in `nums` is an integer greater than or equal to 1 and less than or equal to 100,*);
