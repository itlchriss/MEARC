...
public class Solution {
	...
	//@ requires(*Each element in `nums` is between 1 and 100 (inclusive).*);
	//@ ensures(*The method returns an integer.*);
	//@ ensures(*The returned integer is the sum of the squares of the distinct counts of all subarrays of `nums`.*);
