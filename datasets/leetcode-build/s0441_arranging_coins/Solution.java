...
public class Solution {
	...
	//@ ensures(*The method returns an integer representing the number of complete rows in the staircase.*);
	//@ ensures(*The returned value is greater than or equal to 0.*);
	//@ ensures(*The returned value is less than or equal to the input `n`.*);
