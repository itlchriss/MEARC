...
public class Solution {
	...
	//@ requires(*The grid contains only binary values (0 or 1).*);
	//@ requires(*The top-left cell of the grid is (0, 0).*);
	//@ requires(*The bottom-right cell of the grid is (n - 1, n - 1).*);
