...
public class Solution {
	...
	//@ requires(*The length of the input array `words` is between 1 and - Each element in the input array `words` is not null.*);
	//@ requires(*Each element in the input array `words` is a string consisting of lowercase English letters.*);
	//@ requires(*The length of each element in the input array `words` is between 1 and*);
