...
public class Solution {
	...
	//@ requires(*The length of `nums` is at least 4.*);
	//@ requires(*All integers in `nums` are unique.*);
	//@ requires(*The integers in `nums` are in the range from 1 to the length of `nums`.*);
