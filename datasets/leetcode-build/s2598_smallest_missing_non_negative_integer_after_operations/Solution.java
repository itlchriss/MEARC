...
public class Solution {
	...
	//@ requires(*The value of `value` is greater than or equal to 1.*);
	//@ ensures(*The returned value is the maximum MEX of the modified `nums` array after applying the mentioned operation any number of times.*);
