...
public class Solution {
	...
	//@ ensures(*The output is an integer representing the reversed bits of the input `n`.*);
	//@ ensures(*The output is a binary string of length 32.*);
	//@ ensures(*The output is the unsigned integer representation of the reversed bits of the input `n`.*);
