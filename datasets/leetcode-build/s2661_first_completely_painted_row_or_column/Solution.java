...
public class Solution {
	...
	//@ requires(*The length of `mat` is equal to `m`.*);
	//@ requires(*The length of each row in `mat` is equal to `n`.*);
	//@ requires(*The length of `arr` is equal to `m * n`.*);
	//@ requires(*The integers in `arr` are unique.*);
	//@ requires(*The integers in `mat` are unique.*);
