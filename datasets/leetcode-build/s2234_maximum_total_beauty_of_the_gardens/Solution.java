...
public class Solution {
	//@ requires(*The input array `flowers` must not be null.*);
	//@ requires(*The length of the input array `flowers` must be greater than or equal to 1.*);
	//@ requires(*The elements in the input array `flowers` must be positive integers.*);
	//@ requires(*The input integer `newFlowers` must be a positive integer.*);
	//@ requires(*The input integer `target` must be a positive integer.*);
	//@ requires(*The input integer `full` must be a positive integer.*);
	//@ requires(*The input integer `partial` must be a positive integer.*);
