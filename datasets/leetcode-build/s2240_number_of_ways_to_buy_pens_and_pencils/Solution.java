...
public class Solution {
	//@ requires(*The total money, cost of pen, and cost of pencil must be positive integers.*);
	//@ requires(*The total money must be greater than or equal to the cost of the cheapest writing utensil.*);
