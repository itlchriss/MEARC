...
public class Solution {
	...
	//@ requires(*The length of the input array `nums` must be between 1 and 1000 (inclusive).*);
	//@ requires(*The integers in the input array `nums` must be distinct.*);
	//@ requires(*The input integer `start` must be between 0 and 1000 (inclusive).*);
	//@ requires(*The input integer `goal` must be between -10^9 and 10^9 (inclusive).*);
	//@ requires(*The input integer `start` must not be equal to the input integer `goal`.*);
