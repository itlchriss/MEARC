...
public class Solution {
	...
	//@ requires(*The input list `wordDict` does not contain any duplicate strings.*);
	//@ ensures(*The method returns `true` if `s` can be segmented into a space-separated sequence of one or more dictionary words.*);
	//@ ensures(*The method returns `false` if `s` cannot be segmented into a space-separated sequence of one or more dictionary words.*);
