...
public class Solution {
	...
	//@ ensures(*The returned string is a valid permutation of the input string `s`.*);
	//@ ensures(*The returned string is sorted in decreasing order based on the frequency of characters.*);
