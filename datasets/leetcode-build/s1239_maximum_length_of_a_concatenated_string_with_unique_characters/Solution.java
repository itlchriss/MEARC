...
public class Solution {
	//@ requires(*1. The input list `arr` is not null.*);
	//@ requires(*2. The input list `arr` is not empty.*);
	//@ requires(*3. Each string in the input list `arr` is not null.*);
	//@ requires(*4. Each string in the input list `arr` is not empty.*);
	//@ requires(*5. Each string in the input list `arr` contains only lowercase English letters.*);
