...
public class Solution {
	...
	//@ requires(*The length of the `leftChild` array must be equal to the length of the `rightChild` array.*);
	//@ requires(*The values in the `leftChild` and `rightChild` arrays must be within the range of `-1` to `n - 1`.*);
	//@ requires(*The values in the `leftChild` and `rightChild` arrays must be integers.*);
