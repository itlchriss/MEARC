...
public class Solution {
	//@ requires(*The input string `customers` is not null.*);
	//@ requires(*The length of the input string `customers` is greater than or equal to 1.*);
	//@ requires(*The input string `customers` consists only of characters 'Y' and 'N'.*);
