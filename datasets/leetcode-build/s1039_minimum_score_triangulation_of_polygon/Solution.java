...
public class Solution {
	...
	//@ requires(*The length of the input array `values` is greater than or equal to - The length of the input array `values` is less than or equal to - Each element in the input array `values` is an integer.*);
	//@ requires(*Each element in the input array `values` is greater than or equal to - Each element in the input array `values` is less than or equal to*);
