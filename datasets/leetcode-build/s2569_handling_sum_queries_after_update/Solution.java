...
public class Solution {
	//@ requires(*The length of `nums1` and `nums2` is greater than or equal to 1.*);
	//@ requires(*The length of `nums1` is equal to the length of `nums2`.*);
	//@ requires(*The length of `queries` is greater than or equal to 1.*);
	//@ requires(*Each query in `queries` has a length of 3.*);
	//@ requires(*The value of `l` in a query of type 1 is between 0 and the length of `nums1` - 1.*);
	//@ requires(*The value of `r` in a query of type 1 is between `l` and the length of `nums1` - 1.*);
	//@ requires(*The value of `p` in a query of type 2 is between 0 and 10^6.*);
	//@ requires(*The values in `nums1` are either 0 or 1.*);
	//@ requires(*The values in `nums2` are between 0 and 10^9.*);
