...
public class Solution {
    ...
    */
	...
	//@ requires(*Each element in the input array `nums` is less than or equal to 10^5.*);
	//@ ensures(*The return value is an integer.*);
	//@ ensures(*The return value is the sum of the widths of all the non-empty subsequences of the input array `nums`.*);
