...
public class Solution {
	...
	//@ ensures(*The input matrix is modified in place.*);
	//@ ensures(*All rows and columns that contain a 0 in the original matrix are set to 0 in the modified matrix.*);
	//@ ensures(*The modified matrix is returned.*);
