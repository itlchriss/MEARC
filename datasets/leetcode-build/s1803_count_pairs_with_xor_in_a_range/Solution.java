...
public class Solution {
	...
	//@ requires(*The values in the input array `nums` are between 1 and 2 * 10^4 (inclusive).*);
	//@ requires(*The value of `low` is between 1 and 2 * 10^4 (inclusive).*);
	//@ requires(*The value of `high` is between 1 and 2 * 10^4 (inclusive).*);
	//@ requires(*The value of `low` is less than or equal to `high`.*);
