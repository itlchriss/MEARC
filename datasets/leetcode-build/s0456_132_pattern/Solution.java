...
public class Solution {
	...
	//@ ensures(*The method returns `true` if there is a 132 pattern in the input array `nums`.*);
	//@ ensures(*The method returns `false` if there is no 132 pattern in the input array `nums`.*);
