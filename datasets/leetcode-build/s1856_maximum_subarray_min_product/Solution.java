...
public class Solution {
	...
	//@ requires(*The elements in the input array `nums` are within the range of 1 to 10^7.*);
	//@ ensures(*The method returns an integer value.*);
	//@ ensures(*The returned integer value is the maximum min-product of any non-empty subarray of the input array `nums`.*);
