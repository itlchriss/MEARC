...
public class Solution {
	//@ requires(*The input array `salary` must not be null.*);
	//@ requires(*The length of the input array `salary` must be at least 3.*);
	//@ requires(*All the integers in the input array `salary` must be unique.*);
	//@ requires(*The integers in the input array `salary` must be between 1000 and 10^6 (inclusive).*);
