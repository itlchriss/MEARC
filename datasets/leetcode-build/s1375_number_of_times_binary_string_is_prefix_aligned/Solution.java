...
public class Solution {
	//@ requires(*The input array `flips` is not null.*);
	//@ requires(*The length of `flips` is equal to `n`.*);
	//@ requires(*The elements in `flips` are integers in the range `[1, n]`.*);
	//@ requires(*The binary string is initially all zeros.*);
