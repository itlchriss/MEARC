...
public class Solution {
	...
	//@ requires(*The length of each subarray in `groups` must be greater than or equal to 1.*);
	//@ requires(*The sum of the lengths of all subarrays in `groups` must be less than or equal to 1000.*);
	//@ requires(*The length of the `nums` array must be greater than or equal to 1.*);
	//@ requires(*The values in `groups` and `nums` must be within the range of -10^7 to 10^7.*);
