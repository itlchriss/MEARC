...
public class Solution {
	...
	//@ requires(*The length of the input array `arr` is at least 1 and at most 10^5.*);
	//@ requires(*Each element in the input array `arr` is an integer between -10^4 and 10^4.*);
