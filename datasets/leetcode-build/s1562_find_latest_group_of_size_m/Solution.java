...
public class Solution {
	...
	//@ requires(*The length of the input array `arr` is equal to `n`.*);
	//@ requires(*The input integer `m` is greater than or equal to - The input integer `m` is less than or equal to `n`.*);
	//@ requires(*All integers in the input array `arr` are distinct.*);
