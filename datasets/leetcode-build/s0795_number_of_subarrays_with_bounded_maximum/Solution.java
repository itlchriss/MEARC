...
public class Solution {
	...
	//@ requires(*The values in the input array `nums` are within the range of a 32-bit integer.*);
	//@ requires(*The value of `left` is non-negative.*);
	//@ requires(*The value of `right` is non-negative.*);
