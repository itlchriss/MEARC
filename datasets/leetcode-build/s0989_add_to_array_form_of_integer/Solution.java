...
public class Solution {
	//@ requires(*The input array `num` must not be null.*);
	//@ requires(*The length of the input array `num` must be greater than or equal to 1.*);
	//@ requires(*The elements of the input array `num` must be integers between 0 and 9 (inclusive).*);
