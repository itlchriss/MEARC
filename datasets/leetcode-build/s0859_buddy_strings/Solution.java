...
public class Solution {
	//@ requires(*The lengths of `s` and `goal` are both greater than or equal to - The lengths of `s` and `goal` are both less than or equal to 2 * 10^- `s` and `goal` consist of lowercase letters.*);
