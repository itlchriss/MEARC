...
public class Solution {
	...
	//@ requires(*The length `n` of the input arrays must be between 1 and 10^5.*);
	//@ requires(*The elements of the input arrays `nums1` and `nums2` must be non-negative integers between 0 and 10^5.*);
	//@ requires(*The values of `k1` and `k2` must be non-negative integers between 0 and 10^9.*);
