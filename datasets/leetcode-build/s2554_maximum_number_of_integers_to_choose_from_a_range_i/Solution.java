...
public class Solution {
	//@ requires(*The input array `banned` is not null.*);
	//@ requires(*The input array `banned` contains integers within the range `[1, n]`.*);
	//@ requires(*The input integer `n` is greater than or equal to 1.*);
	//@ requires(*The input integer `maxSum` is greater than or equal to 1.*);
