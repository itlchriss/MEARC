...
public class Solution {
	...
	//@ requires(*The input `delay` is an integer greater than or equal to 1 and less than `forget`.*);
	//@ requires(*The input `forget` is an integer greater than `delay` and less than or equal to `n`.*);
	//@ ensures(*The output is an integer representing the number of people who know the secret at the end of day `n`.*);
	//@ ensures(*The output is less than or equal to `n`.*);
