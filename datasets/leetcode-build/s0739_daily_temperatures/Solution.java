...
public class Solution {
	//@ requires(*The input array `temperatures` is not null.*);
	//@ requires(*The length of the input array `temperatures` is greater than or equal to - Each element in the input array `temperatures` is an integer.*);
	//@ requires(*Each element in the input array `temperatures` is between 30 and 100 (inclusive).*);
