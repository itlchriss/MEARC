...
public class Solution {
	//@ requires(*The input matrix is a 2D integer array.*);
	//@ requires(*The input matrix is not null.*);
	//@ requires(*The input matrix has at least one row and one column.*);
	//@ requires(*The input matrix has a maximum size of 1000 rows and 1000 columns.*);
	//@ requires(*The values in the input matrix are within the range of -10^9 to 10^9.*);
