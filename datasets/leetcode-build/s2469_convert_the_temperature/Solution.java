...
public class Solution {
	//@ requires(*The input `celsius` must be a non-negative floating point number rounded to two decimal places.*);
	//@ requires(*The value of `celsius` must be between 0 and 1000 (inclusive).*);
