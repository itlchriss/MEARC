...
public class Solution {
	//@ requires(*The input `number` is a non-null string.*);
	//@ requires(*The length of `number` is between 2 and 100 (inclusive).*);
	//@ requires(*`number` consists of digits, spaces, and/or dashes.*);
	//@ requires(*There are at least two digits in `number`.*);
