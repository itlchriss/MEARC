...
public class Solution {
	...
	//@ requires(*The length of all strings in `strs` is the same.*);
	//@ requires(*The length of `strs` is greater than or equal to - The length of each string in `strs` is greater than or equal to - Each string in `strs` consists of lowercase English letters.*);
