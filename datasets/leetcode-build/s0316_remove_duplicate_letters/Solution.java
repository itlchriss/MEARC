...
public class Solution {
	...
	//@ ensures(*3. The output string consists only of lowercase English letters.*);
	//@ ensures(*4. The output string is the smallest in lexicographical order among all possible results.*);
