...
public class Solution {
	...
	//@ requires(*The input matrix contains non-negative integers.*);
	//@ requires(*The value of k is a positive integer.*);
	//@ requires(*The value of k is less than or equal to the total number of coordinates in the matrix.*);
