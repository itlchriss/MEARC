...
public class Solution {
	...
	//@ requires(*Each value in the grid represents the elevation at a specific point.*);
	//@ requires(*The rain starts to fall and the depth of the water everywhere is t.*);
	//@ requires(*You can swim from a square to another 4-directionally adjacent square if and only if the elevation of both squares individually are at most t.*);
	//@ requires(*You must stay within the boundaries of the grid during your swim.*);
	//@ ensures(*Return the least time until you can reach the bottom right square (n - 1, n - 1) if you start at the top left square (0, 0).*);
