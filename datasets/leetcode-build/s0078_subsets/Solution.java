...
public class Solution {
	...
	//@ ensures(*The output is a list of lists, representing all possible subsets of the input array `nums`.*);
	//@ ensures(*The output does not contain any duplicate subsets.*);
	//@ ensures(*The order of the subsets in the output can be arbitrary.*);
