...
public class Solution {
	//@ requires(*The input `n` is an integer in base 10.*);
	//@ requires(*The input `k` is an integer representing the base to convert `n` to.*);
	//@ requires(*`n` is greater than or equal to 1 and less than or equal to 100.*);
	//@ requires(*`k` is greater than or equal to 2 and less than or equal to 10.*);
