...
public class Solution {
	...
	//@ requires(*Each word in the input array `words` consists of lowercase English letters.*);
	//@ requires(*The length of each word in the input array `words` is greater than or equal to 1.*);
	//@ requires(*The length of each word in the input array `words` is less than or equal to 16.*);
