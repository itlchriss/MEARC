...
public class Solution {
	...
	//@ requires(*The elements in the input array `nums` are greater than or equal to 1.*);
	//@ requires(*The elements in the input array `nums` are less than or equal to 10^5.*);
