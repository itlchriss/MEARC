...
public class Solution {
	...
	//@ requires(*The input array `packages` must not be null.*);
	//@ requires(*The input array `boxes` must not be null.*);
	//@ requires(*The length of the input array `packages` must be greater than 0.*);
	//@ requires(*The length of the input array `boxes` must be greater than 0.*);
	//@ requires(*The elements in the input array `packages` must be positive integers.*);
	//@ requires(*The elements in the input array `boxes` must be positive integers.*);
	//@ requires(*The elements in the input array `boxes` must be distinct.*);
