...
public class Solution {
	...
	//@ requires(*The input graph must be a valid undirected graph.*);
	//@ requires(*The graph must have at least 3 nodes.*);
	//@ requires(*Each node in the graph must be represented by a unique integer.*);
	//@ requires(*The mouse starts at node 1 and the cat starts at node 2.*);
	//@ requires(*There is a hole at node 0.*);
	//@ requires(*The mouse and the cat can always move.*);
