...
public class Solution {
	...
	//@ ensures(*The elements in the input array `nums` are reordered such that `nums[0] < nums[1] > nums[2] < nums[3]...`.*);
	//@ ensures(*The relative order of the elements that satisfy the above condition is maintained.*);
	//@ ensures(*The elements that do not satisfy the above condition may have any order among themselves.*);
	//@ ensures(*The input array `nums` is modified in-place.*);
