...
public class Solution {
	//@ requires(*The input array `hours` is not null.*);
	//@ requires(*The length of the input array `hours` is greater than or equal to 1.*);
	//@ requires(*The elements in the input array `hours` are non-negative integers.*);
