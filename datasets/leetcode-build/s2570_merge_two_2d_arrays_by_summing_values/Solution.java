...
public class Solution {
	...
	//@ requires(*The length of `nums1` and `nums2` is between 1 and 200 (inclusive).*);
	//@ requires(*Each subarray in `nums1` and `nums2` has a length of 2.*);
	//@ requires(*The ids in `nums1` and `nums2` are unique and sorted in ascending order.*);
	//@ requires(*The values in `nums1` and `nums2` are between 1 and 1000 (inclusive).*);
