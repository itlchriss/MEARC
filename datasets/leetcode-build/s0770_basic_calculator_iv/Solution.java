...
public class Solution {
    ...
    private int i = 0;
	//@ requires(*The expression must be a valid string consisting of lowercase English letters, digits, '+', '-', '*', '(', ')', and ' '.*);
	//@ requires(*The expression must not contain any leading or trailing spaces.*);
	//@ requires(*All tokens in the expression must be separated by a single space.*);
	//@ requires(*The evalvars array must contain valid variable names consisting of lowercase English letters.*);
	//@ requires(*The evalints array must contain valid integer values between -100 and 100.*);
	//@ requires(*The length of the expression must be between 1 and 250.*);
	//@ requires(*The length of each evalvars string must be between 1 and 20.*);
	//@ requires(*The length of the evalvars array must be between 0 and 100.*);
	//@ requires(*The length of the evalints array must be the same as the length of the evalvars array.*);
