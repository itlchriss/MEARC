...
public class Solution {
	//@ requires(*The `boxes` array is not null.*);
	//@ requires(*The length of the `boxes` array is greater than 0 and less than or equal to 10^5.*);
	//@ requires(*The `portsCount` is greater than or equal to 1 and less than or equal to 10^5.*);
	//@ requires(*The `maxBoxes` is greater than or equal to 1 and less than or equal to 10^5.*);
	//@ requires(*The `maxWeight` is greater than or equal to 1 and less than or equal to 10^5.*);
	//@ requires(*The `ports[i]` is greater than or equal to 1 and less than or equal to `portsCount`.*);
	//@ requires(*The `weights[i]` is greater than or equal to 1 and less than or equal to `maxWeight`.*);
