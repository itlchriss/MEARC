...
public class Solution {
	...
	//@ requires(*The input matrix `grid` is a 2D array of integers.*);
	//@ requires(*The length of `grid` is greater than 0.*);
	//@ requires(*The length of each row in `grid` is greater than 0.*);
