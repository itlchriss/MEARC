...
public class Solution {
	...
	//@ requires(*The elements in the input array `nums` must be within the range of -1000 to 1000.*);
	//@ ensures(*The method returns an integer value.*);
	//@ ensures(*The returned integer value is the maximum product of three numbers from the input array `nums`.*);
