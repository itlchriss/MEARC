...
public class Solution {
	...
	//@ requires(*The input strings `s` and `goal` are not null.*);
	//@ requires(*The lengths of `s` and `goal` are between 1 and 100 (inclusive).*);
	//@ requires(*`s` and `goal` consist only of lowercase English letters.*);
