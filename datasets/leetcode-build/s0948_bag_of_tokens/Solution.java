...
public class Solution {
	//@ requires(*The input array `tokens` must not be null.*);
	//@ requires(*The input array `tokens` must have a length between 0 and - The input integer `power` must be between 0 and*);
