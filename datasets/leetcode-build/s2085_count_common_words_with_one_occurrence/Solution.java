...
public class Solution {
	...
	//@ requires(*The lengths of `words1` and `words2` are between 1 and 1000, inclusive.*);
	//@ requires(*The lengths of the strings in `words1` and `words2` are between 1 and 30, inclusive.*);
	//@ requires(*The strings in `words1` and `words2` consist only of lowercase English letters.*);
