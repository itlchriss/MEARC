...
public class Solution {
	...
	//@ requires(*The input array `nums` has a length less than or equal to 1000.*);
	//@ requires(*The input array `nums` contains integers between 1 and 1000.*);
	//@ requires(*The input integer `key` is an element from the array `nums`.*);
	//@ requires(*The input integer `k` is greater than or equal to 1.*);
	//@ requires(*The input integer `k` is less than or equal to the length of the array `nums`.*);
