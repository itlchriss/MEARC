...
public class Solution {
	...
	//@ requires(*The length of `logs` is greater than or equal to 1 and less than or equal to 100.*);
	//@ requires(*Each element in `logs` is an array of length 2.*);
	//@ requires(*The birth year `birth_i` is greater than or equal to 1950 and less than the death year `death_i`.*);
	//@ requires(*The death year `death_i` is greater than the birth year `birth_i` and less than or equal to 2050.*);
