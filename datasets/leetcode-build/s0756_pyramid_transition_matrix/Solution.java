...
public class Solution {
	...
	//@ requires(*The length of the `bottom` string is between 2 and 6, inclusive.*);
	//@ requires(*The length of each string in the `allowed` list is 3.*);
	//@ requires(*The letters in the `bottom` string and the `allowed` list are from the set {'A', 'B', 'C', 'D', 'E', 'F'}.*);
	//@ requires(*All the values in the `allowed` list are unique.*);
