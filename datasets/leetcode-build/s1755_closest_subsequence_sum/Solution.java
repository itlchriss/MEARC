...
public class Solution {
	...
	//@ requires(*The length of the input array `nums` must be less than or equal to 40.*);
	//@ requires(*Each element in the input array `nums` must be an integer.*);
	//@ requires(*Each element in the input array `nums` must be greater than or equal to -10^7.*);
	//@ requires(*Each element in the input array `nums` must be less than or equal to 10^7.*);
	//@ requires(*The input integer `goal` must be greater than or equal to -10^9.*);
	//@ requires(*The input integer `goal` must be less than or equal to 10^9.*);
