...
public class Solution {
	//@ requires(*The input array `nextVisit` is not null.*);
	//@ requires(*The length of the input array `nextVisit` is greater than or equal to 2.*);
	//@ requires(*The values in the input array `nextVisit` are non-negative integers.*);
	//@ requires(*The values in the input array `nextVisit` are less than or equal to the corresponding indices.*);
