...
public class Solution {
	//@ requires(*The input array `rods` is not null.*);
	//@ requires(*The length of the input array `rods` is greater than or equal to 1.*);
	//@ requires(*The length of the input array `rods` is less than or equal to 20.*);
	//@ requires(*Each element in the input array `rods` is greater than or equal to 1.*);
	//@ requires(*Each element in the input array `rods` is less than or equal to 1000.*);
	//@ requires(*The sum of all elements in the input array `rods` is less than or equal to 5000.*);
