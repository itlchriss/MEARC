...
public class Solution {
	...
	//@ requires(*The grid must have at least one row and one column.*);
	//@ requires(*The grid must have exactly one starting square with a value of - The grid must have exactly one ending square with a value of - The grid may contain empty squares with a value of - The grid may contain obstacles with a value of -*);
