...
public class Solution {
	//@ requires(*The input integer `n` represents the length of the unknown array.*);
	//@ requires(*The input array `sums` contains the values of all subset sums of the unknown array.*);
	//@ requires(*The length of `sums` is equal to `2^n`.*);
	//@ requires(*The values in `sums` are integers between -10^4 and 10^4.*);
