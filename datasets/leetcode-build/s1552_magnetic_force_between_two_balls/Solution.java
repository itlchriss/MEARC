...
public class Solution {
	...
	//@ requires(*The length of the input array `position` is greater than or equal to 2.*);
	//@ requires(*The input integer `m` is greater than or equal to 2.*);
	//@ requires(*The length of the input array `position` is greater than or equal to the input integer `m`.*);
	//@ requires(*All integers in the input array `position` are distinct.*);
