...
public class Solution {
	...
	//@ requires(*Each element in the input `edges` is an array of integers.*);
	//@ requires(*Each element in the input `edges` represents an edge between two nodes in the tree.*);
	//@ requires(*The input `price` is an array of integers.*);
	//@ requires(*The length of the input `price` is equal to `n`.*);
	//@ requires(*Each element in the input `price` is a positive integer.*);
