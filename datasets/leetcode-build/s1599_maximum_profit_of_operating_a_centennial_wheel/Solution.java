...
public class Solution {
	//@ requires(*The input array `customers` must not be null.*);
	//@ requires(*The length of the input array `customers` must be greater than 0.*);
	//@ requires(*The values in the input array `customers` must be non-negative integers.*);
	//@ requires(*The values in the input array `customers` must not exceed 50.*);
	//@ requires(*The values of `boardingCost` and `runningCost` must be positive integers.*);
	//@ requires(*The value of `boardingCost` must not exceed 100.*);
	//@ requires(*The value of `runningCost` must not exceed 100.*);
