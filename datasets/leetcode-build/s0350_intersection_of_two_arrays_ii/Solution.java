...
public class Solution {
	...
	//@ requires(*The elements of `nums1` and `nums2` are integers.*);
	//@ requires(*The elements of `nums1` and `nums2` are non-negative.*);
	//@ requires(*The lengths of `nums1` and `nums2` are less than or equal to 1000.*);
	//@ requires(*The elements of `nums1` and `nums2` are less than or equal to 1000.*);
	//@ ensures(*The method returns an array of integers.*);
	//@ ensures(*The elements in the result array appear as many times as they show in both `nums1` and `nums2`.*);
	//@ ensures(*The order of elements in the result array can be any order.*);
