...
public class Solution {
	//@ requires(*The input array `bits` is not null.*);
	//@ requires(*The length of the input array `bits` is greater than or equal to 1.*);
	//@ requires(*The last element of the input array `bits` is 0.*);
