...
public class Solution {
	//@ requires(*The input string `message` is not null.*);
	//@ requires(*The input string `message` is not empty.*);
	//@ requires(*The input integer `limit` is a positive integer.*);
	//@ requires(*The length of `message` is greater than or equal to `limit`.*);
