...
public class Solution {
	...
	//@ requires(*The length of `word` is greater than or equal to 1 and less than or equal to 10^5.*);
	//@ requires(*`word` consists of lowercase English letters from 'a' to 'j'.*);
