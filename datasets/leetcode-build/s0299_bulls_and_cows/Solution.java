...
public class Solution {
	//@ requires(*The length of the secret number and the guess number should be the same.*);
	//@ requires(*The secret number and the guess number should consist of digits only.*);
	//@ ensures(*The hint should be formatted as "xAyB", where x is the number of bulls and y is the number of cows.*);
	//@ ensures(*The hint should be returned as a string.*);
