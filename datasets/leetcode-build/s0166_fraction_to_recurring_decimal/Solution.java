...
public class Solution {
	//@ requires(*The numerator and denominator are integers.*);
	//@ requires(*The numerator and denominator are within the range of -2^31 to 2^31 - - The denominator is not equal to zero.*);
	//@ ensures(*The method returns a string representation of the fraction.*);
	//@ ensures(*If the fractional part is repeating, it is enclosed in parentheses.*);
	//@ ensures(*The length of the returned string is less than 10^4.*);
