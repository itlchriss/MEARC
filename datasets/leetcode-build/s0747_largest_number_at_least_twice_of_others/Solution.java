...
public class Solution {
	...
	//@ requires(*The length of the input array `nums` is at least 1 and at most 50.*);
	//@ requires(*Each element in the input array `nums` is an integer between 0 and 100 (inclusive).*);
	//@ requires(*The largest element in the input array `nums` is unique.*);
