...
public class Solution {
	...
	//@ requires(*The length of the input array `nums` must be greater than or equal to - The value of `indexDifference` must be greater than or equal to - The value of `valueDifference` must be greater than or equal to*);
