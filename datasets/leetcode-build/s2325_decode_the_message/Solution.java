...
public class Solution {
	//@ requires(*The length of `key` is between 26 and 2000.*);
	//@ requires(*`key` consists of lowercase English letters and spaces.*);
	//@ requires(*`key` contains every letter in the English alphabet at least once.*);
	//@ requires(*The length of `message` is between 1 and 2000.*);
	//@ requires(*`message` consists of lowercase English letters and spaces.*);
