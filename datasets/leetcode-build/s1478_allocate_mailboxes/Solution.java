...
public class Solution {
	//@ requires(*The input array `houses` is not null.*);
	//@ requires(*The input array `houses` is not empty.*);
	//@ requires(*The input integer `k` is greater than or equal to - The input integer `k` is less than or equal to the length of the `houses` array.*);
	//@ requires(*The integers in the `houses` array are unique.*);
	//@ ensures(*The method returns an integer representing the minimum total distance between each house and its nearest mailbox.*);
