...
public class Solution {
	...
	//@ requires(*The length of the input array `encoded` is equal to `n - 1`, where `n` is the length of the original array `perm`.*);
	//@ requires(*The length of the input array `encoded` is at least 2.*);
	//@ requires(*The elements in the input array `encoded` are non-negative integers.*);
