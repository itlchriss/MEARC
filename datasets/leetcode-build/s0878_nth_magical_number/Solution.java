...
public class Solution {
	...
	//@ requires(*The input values `n`, `a`, and `b` are positive integers.*);
	//@ requires(*The values of `a` and `b` are greater than or equal to 2.*);
	//@ requires(*The value of `n` is less than or equal to 10^9.*);
	//@ requires(*The values of `a` and `b` are less than or equal to 4 * 10^4.*);
