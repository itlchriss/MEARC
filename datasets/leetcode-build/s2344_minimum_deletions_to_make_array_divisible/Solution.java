...
public class Solution {
	//@ requires(*The input arrays `nums` and `numsDivide` are not null.*);
	//@ requires(*The length of `nums` and `numsDivide` is greater than or equal to 1.*);
	//@ requires(*The elements in `nums` and `numsDivide` are positive integers.*);
	//@ requires(*The length of `nums` and `numsDivide` is less than or equal to 10^5.*);
