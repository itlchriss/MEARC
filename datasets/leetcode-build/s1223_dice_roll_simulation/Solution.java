...
public class Solution {
	...
	//@ requires(*The input array `rollMax` must have a length of - The elements of `rollMax` must be integers.*);
	//@ requires(*The elements of `rollMax` must be between 1 and 15 (inclusive).*);
	//@ requires(*The input integer `n` must be between 1 and 5000 (inclusive).*);
