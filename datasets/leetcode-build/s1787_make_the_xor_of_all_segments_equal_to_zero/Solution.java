...
public class Solution {
	...
	//@ requires(*Each element in the input array `nums` is a non-negative integer less than*);
	//@ ensures(*The method returns an integer representing the minimum number of elements to change in the array.*);
	//@ ensures(*The input array `nums` may be modified.*);
