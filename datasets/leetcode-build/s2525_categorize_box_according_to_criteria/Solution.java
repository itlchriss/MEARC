...
public class Solution {
	//@ requires(*The input values `length`, `width`, `height`, and `mass` are integers.*);
	//@ requires(*The values of `length`, `width`, and `height` are between 1 and 10^5 (inclusive).*);
	//@ requires(*The value of `mass` is between 1 and 10^3 (inclusive).*);
