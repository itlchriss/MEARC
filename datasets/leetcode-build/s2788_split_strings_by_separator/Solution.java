...
public class Solution {
	//@ requires(*The input list `words` must not be null.*);
	//@ requires(*The input list `words` must not be empty.*);
	//@ requires(*The input list `words` must contain strings.*);
	//@ requires(*The input character `separator` must not be null.*);
