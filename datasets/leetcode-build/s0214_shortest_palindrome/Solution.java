...
public class Solution {
	...
	//@ requires(*2. The input string `s` consists of lowercase English letters only.*);
	//@ ensures(*1. The output string is a palindrome.*);
	//@ ensures(*2. The output string is the shortest palindrome that can be formed by adding characters in front of the input string `s`.*);
