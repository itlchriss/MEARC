...
public class Solution {
	//@ requires(*The values of `sx`, `sy`, `tx`, and `ty` are integers.*);
	//@ requires(*The values of `sx`, `sy`, `tx`, and `ty` are greater than or equal to 1.*);
	//@ requires(*The values of `sx`, `sy`, `tx`, and `ty` are less than or equal to 10^9.*);
