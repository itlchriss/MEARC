...
public class Solution {
	...
	//@ requires(*The input array `jobs` is not null.*);
	//@ requires(*The length of the input array `jobs` is greater than or equal to `k`.*);
	//@ requires(*The input integer `k` is greater than or equal to 1.*);
	//@ requires(*Each element in the input array `jobs` is a positive integer.*);
