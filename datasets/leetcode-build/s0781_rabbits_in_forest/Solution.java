...
public class Solution {
	//@ requires(*The input array `answers` is not null.*);
	//@ requires(*The length of the input array `answers` is greater than or equal to 1.*);
	//@ requires(*Each element in the input array `answers` is a non-negative integer.*);
