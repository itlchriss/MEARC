...
public class Solution {
	//@ requires(*The input array `prizePositions` is not null.*);
	//@ requires(*The input array `prizePositions` is sorted in non-decreasing order.*);
	//@ requires(*The input integer `k` is not negative.*);
