...
public class Solution {
	//@ requires(*The `bottom` and `top` values must be valid floor numbers, where `bottom` is less than or equal to `top`.*);
	//@ requires(*The `special` array must not be empty.*);
	//@ requires(*The values in the `special` array must be valid floor numbers, where each value is greater than or equal to `bottom` and less than or equal to `top`.*);
	//@ requires(*All the values in the `special` array must be unique.*);
