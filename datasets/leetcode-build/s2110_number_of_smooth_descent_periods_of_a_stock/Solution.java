...
public class Solution {
	...
	//@ requires(*The elements in the input array `prices` are integers.*);
	//@ requires(*The elements in the input array `prices` are greater than or equal to 1.*);
	//@ requires(*The elements in the input array `prices` are less than or equal to 10^5.*);
