...
public class Solution {
	...
	//@ requires(*The input array `neededTime` is not null.*);
	//@ requires(*The length of `colors` is equal to the length of `neededTime`.*);
	//@ requires(*The length of `colors` is greater than 1.*);
