...
public class Solution {
	...
	//@ requires(*Each string in the input array `words` consists of lowercase English letters only.*);
	//@ requires(*No letter occurs more than once in any string in the input array `words`.*);
