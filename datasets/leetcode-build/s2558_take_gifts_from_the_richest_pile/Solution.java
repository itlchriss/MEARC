...
public class Solution {
	//@ requires(*The input array `gifts` is not null.*);
	//@ requires(*The length of the input array `gifts` is greater than or equal to 1.*);
	//@ requires(*The elements in the input array `gifts` are positive integers.*);
