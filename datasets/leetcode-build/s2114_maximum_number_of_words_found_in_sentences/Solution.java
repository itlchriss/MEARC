...
public class Solution {
	//@ requires(*The input array `sentences` is not null.*);
	//@ requires(*The length of the input array `sentences` is greater than or equal to 1.*);
	//@ requires(*Each element in the input array `sentences` is not null.*);
	//@ requires(*Each element in the input array `sentences` is a valid sentence (a list of words separated by a single space).*);
	//@ requires(*Each element in the input array `sentences` does not have leading or trailing spaces.*);
	//@ requires(*All the words in each element of the input array `sentences` are separated by a single space.*);
