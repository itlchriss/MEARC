...
public class Solution {
	//@ requires(*The input array `mountain` is not null.*);
	//@ requires(*The length of the input array `mountain` is at least - The elements in the input array `mountain` are integers.*);
	//@ requires(*The elements in the input array `mountain` are between 1 and 100 (inclusive).*);
