...
public class Solution {
	...
	//@ requires(*The input array `nums` must have at least one element.*);
	//@ requires(*The input array `nums` must contain only integers.*);
	//@ requires(*The input integer `limit` must be non-negative.*);
