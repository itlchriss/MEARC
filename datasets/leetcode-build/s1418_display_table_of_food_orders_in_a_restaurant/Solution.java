...
public class Solution {
	//@ requires(*1. The input list "orders" is not null.*);
	//@ requires(*2. The length of "orders" is greater than or equal to 1.*);
	//@ requires(*3. Each element in "orders" is a list of length 3.*);
	//@ requires(*4. The length of the customer name and food item in each order is between 1 and 20.*);
	//@ requires(*5. The table number in each order is a valid integer between 1 and 500.*);
