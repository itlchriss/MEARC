...
public class Solution {
	...
	//@ requires(*The length of the input list `nums` is less than or equal to 10^4.*);
	//@ requires(*Each element in the input list `nums` is an integer.*);
	//@ requires(*Each element in the input list `nums` is greater than or equal to 1.*);
	//@ requires(*Each element in the input list `nums` is less than or equal to 10^9.*);
