...
public class Solution {
	...
	//@ requires(*The input matrix `mat` has a valid size, where `m` is the number of rows and `n` is the number of columns.*);
	//@ requires(*The elements of the input matrix `mat` are either 0 or*);
