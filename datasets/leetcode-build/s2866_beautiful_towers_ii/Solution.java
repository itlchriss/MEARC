...
public class Solution {
	//@ requires(*The input list `mH` must not be null.*);
	//@ requires(*The length of the input list `mH` must be greater than - The elements in the input list `mH` must be integers.*);
	//@ requires(*The elements in the input list `mH` must be greater than or equal to - The elements in the input list `mH` must be less than or equal to 10^*);
