...
public class Solution {
	...
	//@ ensures(*The returned list contains all elements that appear more than ⌊ n/3 ⌋ times in the input array `nums`.*);
	//@ ensures(*The order of elements in the returned list is not specified.*);
	//@ ensures(*The method runs in linear time.*);
	//@ ensures(*The method uses O(1) space.*);
