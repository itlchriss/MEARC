...
public class Solution {
	//@ requires(*The `text` parameter is a non-empty string.*);
	//@ requires(*The `brokenLetters` parameter is a string containing distinct lowercase English letters.*);
	//@ requires(*The `text` parameter consists of words separated by a single space without any leading or trailing spaces.*);
	//@ requires(*Each word in the `text` parameter only consists of lowercase English letters.*);
