...
public class Solution {
    ...
    private int res;
	//@ requires(*The input values `n` and `m` must be integers.*);
	//@ requires(*The values of `n` and `m` must be greater than or equal to 1 and less than or equal to*);
	//@ ensures(*The method should return an integer value representing the minimum number of squares needed to tile the rectangle.*);
	//@ ensures(*The returned value should be greater than or equal to 1.*);
