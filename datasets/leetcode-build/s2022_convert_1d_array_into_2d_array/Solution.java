...
public class Solution {
	//@ requires(*The `original` array must not be null.*);
	//@ requires(*The length of the `original` array must be greater than or equal to `n`.*);
	//@ requires(*The values in the `original` array must be within the range of 1 to 10^- The values of `m` and `n` must be within the range of 1 to 4 * 10^*);
