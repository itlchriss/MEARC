...
public class Solution {
	...
	//@ requires(*The input array `change` must not be null.*);
	//@ requires(*The length of `num` must be greater than or equal to 1 and less than or equal to 10^5.*);
	//@ requires(*The length of `change` must be equal to 10.*);
	//@ requires(*Each element in `change` must be an integer between 0 and 9 (inclusive).*);
