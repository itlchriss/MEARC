...
public class Solution {
	...
	//@ requires(*Each element in the input array `nums` is less than or equal to 30.*);
	//@ ensures(*The method returns an integer value.*);
	//@ ensures(*The returned integer value represents the number of square-free non-empty subsets of the input array `nums`.*);
	//@ ensures(*The returned integer value is greater than or equal to 0.*);
	//@ ensures(*The returned integer value is less than or equal to 10^9 + 7.*);
