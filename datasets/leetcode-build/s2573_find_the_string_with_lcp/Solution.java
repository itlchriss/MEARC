...
public class Solution {
	//@ requires(*The input matrix `lcp` is not null.*);
	//@ requires(*The length of `lcp` is equal to the length of `lcp[i]`.*);
	//@ requires(*The length of `lcp` is greater than 0 and less than or equal to 1000.*);
	//@ requires(*The values in `lcp` are non-negative integers.*);
	//@ requires(*The values in `lcp` are less than or equal to the length of `lcp`.*);
