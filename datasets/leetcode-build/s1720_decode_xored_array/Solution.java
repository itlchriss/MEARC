...
public class Solution {
	//@ requires(*The input array `encoded` is not null.*);
	//@ requires(*The length of `encoded` is equal to `n - 1`, where `n` is the length of the original array `arr`.*);
	//@ requires(*The elements of `encoded` are non-negative integers.*);
	//@ requires(*The input integer `first` is not null.*);
	//@ requires(*The value of `first` is a non-negative integer.*);
