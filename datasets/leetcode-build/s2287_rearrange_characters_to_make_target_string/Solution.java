...
public class Solution {
	//@ requires(*The input strings `s` and `target` are not null.*);
	//@ requires(*The length of `s` is greater than or equal to the length of `target`.*);
	//@ requires(*The strings `s` and `target` consist of lowercase English letters.*);
