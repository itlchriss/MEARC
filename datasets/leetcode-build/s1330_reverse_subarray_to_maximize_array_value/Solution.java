...
public class Solution {
	...
	//@ requires(*3. The elements in the input array `nums` must be integers.*);
	//@ requires(*4. The elements in the input array `nums` must be within the range of -10^5 to 10^5.*);
