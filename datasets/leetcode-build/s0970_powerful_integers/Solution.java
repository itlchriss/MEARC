...
public class Solution {
	//@ requires(*The values of x and y must be integers greater than or equal to 1 and less than or equal to 100.*);
	//@ requires(*The value of bound must be an integer greater than or equal to 0 and less than or equal to 10^6.*);
