...
public class Solution {
	...
	//@ requires(*The length of `nums` is less than or equal to 1000.*);
	//@ requires(*Each element in `nums` is a positive integer.*);
	//@ requires(*The value of `n` is equal to the length of `nums`.*);
	//@ requires(*The value of `left` is greater than or equal to 1.*);
	//@ requires(*The value of `right` is less than or equal to `n * (n + 1) / 2`.*);
	//@ requires(*The value of `left` is less than or equal to the value of `right`.*);
