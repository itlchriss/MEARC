...
public class Solution {
	...
	//@ requires(*2. The length of the input array `nums` is a multiple of 3.*);
	//@ requires(*3. The value of `n` is a positive integer.*);
	//@ requires(*4. The values in the input array `nums` are positive integers.*);
	//@ requires(****);
	//@ ensures(****);
