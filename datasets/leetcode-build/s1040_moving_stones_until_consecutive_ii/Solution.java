...
public class Solution {
	...
	//@ requires(*The length of the input array `stones` is at least 3.*);
	//@ requires(*All the values in the input array `stones` are unique.*);
	//@ requires(*The values in the input array `stones` are within the range of 1 to 10^9.*);
