...
public class Solution {
	...
	//@ requires(*The length of `s` is between 1 and 10^- `s` consists of lowercase English letters and spaces.*);
	//@ requires(*There is a single space between consecutive words.*);
