...
public class Solution {
	...
	//@ requires(*Each string in the input array `words` is not null.*);
	//@ requires(*Each string in the input array `words` is unique.*);
	//@ requires(*Each string in the input array `words` consists of lowercase English letters.*);
	//@ requires(*The length of each string in the input array `words` is greater than or equal to 1.*);
	//@ requires(*The length of each string in the input array `words` is less than or equal to 20.*);
	//@ ensures(*The output string is not null.*);
	//@ ensures(*The output string contains each string in the input array `words` as a substring.*);
	//@ ensures(*The output string is the smallest string that satisfies the above condition.*);
	//@ ensures(*If there are multiple valid strings of the smallest length, any of them can be returned as the output.*);
