...
public class Solution {
	...
	//@ requires(*The input `ranges` is an array of integers with length `n + 1`.*);
	//@ requires(*Each element in `ranges` is a non-negative integer.*);
	//@ requires(*The length of `ranges` is equal to `n + 1`.*);
