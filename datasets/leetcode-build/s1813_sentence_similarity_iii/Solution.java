...
public class Solution {
	//@ requires(*The input sentences `sentence1` and `sentence2` are not null.*);
	//@ requires(*The lengths of `sentence1` and `sentence2` are between 1 and 100 (inclusive).*);
	//@ requires(*The words in `sentence1` and `sentence2` consist of only uppercase and lowercase English letters.*);
	//@ requires(*The words in `sentence1` and `sentence2` are separated by a single space.*);
