...
public class Solution {
	//@ requires(*The input array `plants` is not null.*);
	//@ requires(*The input array `plants` has at least one element.*);
	//@ requires(*The input array `plants` contains only positive integers.*);
	//@ requires(*The input integer `capacity` is greater than or equal to the maximum value in the `plants` array.*);
