...
public class Solution {
	//@ requires(*The input array `bills` is not null.*);
	//@ requires(*The length of the input array `bills` is greater than or equal to 1.*);
	//@ requires(*Each element in the input array `bills` is either 5, 10, or 20.*);
