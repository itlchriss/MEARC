...
public class Solution {
    static class Exp {
        ...
        String op;
        Exp parent;
	//@ requires(*The input expression is a valid Lisp-like expression.*);
	//@ requires(*The expression does not have any leading or trailing spaces.*);
	//@ requires(*All tokens in the expression are separated by a single space.*);
	//@ requires(*The answer and all intermediate calculations of that answer will fit in a 32-bit integer.*);
	//@ ensures(*The method returns the integer value of the given Lisp-like expression.*);
