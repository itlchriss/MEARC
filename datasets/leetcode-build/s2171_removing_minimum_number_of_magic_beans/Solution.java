...
public class Solution {
	//@ requires(*The input array `beans` is not null.*);
	//@ requires(*The length of the input array `beans` is greater than or equal to 1.*);
	//@ requires(*Each element in the input array `beans` is a positive integer.*);
