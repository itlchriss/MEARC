...
public class Solution {
	...
	//@ requires(*2. The length of the input array `nums` is greater than or equal to 2.*);
	//@ ensures(*1. The method returns an integer representing the number of reverse pairs in the array.*);
