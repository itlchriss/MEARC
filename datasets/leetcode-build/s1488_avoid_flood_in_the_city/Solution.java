...
public class Solution {
	//@ requires(*The input array `rains` is not null.*);
	//@ requires(*The length of the input array `rains` is greater than or equal to 1.*);
	//@ requires(*The elements of the input array `rains` are integers.*);
	//@ requires(*The elements of the input array `rains` are greater than or equal to 0.*);
