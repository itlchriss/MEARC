...
public class Solution {
	...
	//@ ensures(*The method returns an integer representing the number of non-negative integers in the range `[0, n]` whose binary representations do not contain consecutive ones.*);
