...
public class Solution {
	//@ requires(*The input array `chalk` is not null.*);
	//@ requires(*The length of the input array `chalk` is equal to `n`.*);
	//@ requires(*The input integer `k` is greater than or equal to 0.*);
	//@ requires(*The input integer `n` is greater than or equal to 1.*);
	//@ requires(*Each element in the input array `chalk` is greater than or equal to 1.*);
	//@ requires(*The sum of all elements in the input array `chalk` is less than or equal to `k`.*);
