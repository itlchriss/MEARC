...
public class Solution {
	...
	//@ requires(*The values in `nums` are integers.*);
	//@ requires(*The value of `minK` is an integer.*);
	//@ requires(*The value of `maxK` is an integer.*);
	//@ requires(*The value of `minK` is less than or equal to the value of `maxK`.*);
	//@ requires(*The value of `minK` is within the range of values in `nums`.*);
	//@ requires(*The value of `maxK` is within the range of values in `nums`.*);
