...
public class Solution {
	...
	//@ requires(*The input list `parent` is not null.*);
	...
	//@ requires(*The first element of `parent` is -1.*);
	//@ requires(*All elements of `parent` are integers between 0 and n-1, inclusive.*);
