...
public class Solution {
	...
	//@ requires(*3. The input matrix must contain only '0' and '1' characters.*);
	//@ ensures(*1. The returned value must be an integer.*);
	//@ ensures(*2. The returned value must be the area of the largest square containing only '1's in the input matrix.*);
