...
public class Solution {
	...
	//@ requires(*The input list `nums` must have a length greater than or equal to `x`.*);
	//@ requires(*The input integer `x` must be non-negative.*);
	//@ requires(*The input integer `x` must be less than the length of the input list `nums`.*);
