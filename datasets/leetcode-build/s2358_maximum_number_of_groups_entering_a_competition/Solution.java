...
public class Solution {
	//@ requires(*The input array `grades` is not null.*);
	//@ requires(*The length of the input array `grades` is greater than or equal to 1.*);
	//@ requires(*Each element in the input array `grades` is a positive integer.*);
	//@ requires(*The input array `grades` is not empty.*);
