...
public class Solution {
    ...
    private int x;
	//@ requires(*The input `x` is a positive integer.*);
	//@ requires(*The input `target` is a positive integer.*);
	//@ requires(*The value of `x` is between 2 and 100 (inclusive).*);
	//@ requires(*The value of `target` is between 1 and 200,000,000 (inclusive).*);
