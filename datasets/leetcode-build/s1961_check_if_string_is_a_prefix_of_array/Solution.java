...
public class Solution {
	...
	//@ requires(*The length of each string in the input array `words` is greater than 0.*);
	//@ requires(*The length of the input string `s` is greater than 0.*);
	//@ requires(*The input string `s` and each string in the input array `words` consist of only lowercase English letters.*);
