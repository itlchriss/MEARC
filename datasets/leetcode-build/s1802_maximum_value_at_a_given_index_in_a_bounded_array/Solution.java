...
public class Solution {
	...
	//@ requires(*The input integers `n`, `index`, and `maxSum` are positive.*);
	//@ requires(*The value of `n` is greater than or equal to 1.*);
	//@ requires(*The value of `index` is greater than or equal to 0 and less than `n`.*);
	//@ requires(*The value of `maxSum` is greater than or equal to `n`.*);
