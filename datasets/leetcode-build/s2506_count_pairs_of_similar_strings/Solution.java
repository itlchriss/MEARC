...
public class Solution {
	...
	//@ requires(*The length of the input array `words` is greater than or equal to 2.*);
	//@ requires(*Each string in the input array `words` is not null.*);
	//@ requires(*Each string in the input array `words` consists of only lowercase English letters.*);
