...
public class Solution {
	...
	//@ requires(*The length `n` of the input arrays must be at least 1 and at most 1000.*);
	//@ requires(*Each element in `nums1` and `nums2` must be an integer between 1 and 10^9 (inclusive).*);
