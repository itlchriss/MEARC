...
public class Solution {
	//@ requires(*The input arrays `nums`, `l`, and `r` are not null.*);
	//@ requires(*The length of `nums` is greater than or equal to 2.*);
	//@ requires(*The length of `l` is equal to the length of `r`.*);
	//@ requires(*The length of `l` is greater than or equal to 1.*);
	//@ requires(*The values in `l` and `r` are valid indices for the array `nums`.*);
	//@ requires(*The values in `l` are less than the corresponding values in `r`.*);
