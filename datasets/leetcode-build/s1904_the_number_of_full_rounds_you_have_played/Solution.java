...
public class Solution {
	...
	//@ requires(*The loginTime and logoutTime are in the format "hh:mm".*);
	//@ requires(*The loginTime and logoutTime are not equal.*);
	//@ ensures(*The method returns the number of full chess rounds played in the tournament.*);
	//@ ensures(*If logoutTime is earlier than loginTime, the method considers the player has played from loginTime to midnight and from midnight to logoutTime.*);
