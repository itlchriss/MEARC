...
public class Solution {
	...
	//@ requires(*The length of the input array `edges` is greater than or equal to 2.*);
	//@ requires(*The length of the input array `edges` is less than or equal to 10^5.*);
	//@ requires(*Each element in the input array `edges` is a non-negative integer.*);
	//@ requires(*Each element in the input array `edges` is less than the length of the input array `edges`.*);
	//@ requires(*Each node in the directed graph has exactly one outgoing edge.*);
