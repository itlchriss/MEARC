...
public class Solution {
	//@ requires(*The input array `amount` must have a length of 3.*);
	//@ requires(*Each element in the `amount` array must be a non-negative integer.*);
	//@ requires(*The sum of all elements in the `amount` array must be greater than 0.*);
