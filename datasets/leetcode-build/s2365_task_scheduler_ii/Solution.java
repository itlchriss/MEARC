...
public class Solution {
	//@ requires(*The input array `tasks` is not null.*);
	//@ requires(*The input array `tasks` is not empty.*);
	//@ requires(*The input array `tasks` contains only positive integers.*);
	//@ requires(*The input integer `space` is positive.*);
	//@ requires(*The input integer `space` is less than or equal to the length of the `tasks` array.*);
