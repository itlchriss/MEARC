...
public class Solution {
	//@ requires(*The length of string `s` is greater than or equal to the length of string `t`.*);
	//@ requires(*The length of string `s` and string `t` is less than or equal to 10^5.*);
	//@ requires(*The value of `k` is between 0 and 10^9.*);
	//@ requires(*String `s` and string `t` contain only lowercase English letters.*);
