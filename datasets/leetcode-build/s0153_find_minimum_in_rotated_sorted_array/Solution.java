...
public class Solution {
	...
	//@ requires(*The input array `nums` contains unique elements.*);
	//@ requires(*The input array `nums` is rotated between 1 and n times.*);
	//@ ensures(*The output is the minimum element of the input array `nums`.*);
	//@ ensures(*The output is an integer.*);
	//@ ensures(*The algorithm runs in O(log n) time.*);
