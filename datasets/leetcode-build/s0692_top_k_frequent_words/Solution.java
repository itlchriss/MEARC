...
public class Solution {
	...
	//@ requires(*The input integer `k` is greater than - The length of the input array `words` is greater than or equal to `k`.*);
	//@ ensures(*The method returns a list of strings.*);
	//@ ensures(*The returned list contains the `k` most frequent strings from the input array `words`.*);
	//@ ensures(*The strings in the returned list are sorted by their frequency from highest to lowest.*);
	//@ ensures(*If two strings have the same frequency, they are sorted by their lexicographical order.*);
