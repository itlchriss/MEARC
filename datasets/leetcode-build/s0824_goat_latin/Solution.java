...
public class Solution {
	...
	//@ requires(*The input sentence consists of words separated by spaces.*);
	//@ requires(*Each word in the sentence consists of lowercase and uppercase letters only.*);
	//@ requires(*The sentence has no leading or trailing spaces.*);
	//@ requires(*All the words in the sentence are separated by a single space.*);
