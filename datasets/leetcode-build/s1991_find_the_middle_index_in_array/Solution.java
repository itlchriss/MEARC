...
public class Solution {
	...
	//@ requires(*The length of the input array `nums` is at least 1 and at most - Each element in the input array `nums` is an integer.*);
	//@ requires(*Each element in the input array `nums` is between -1000 and*);
