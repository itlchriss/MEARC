...
public class Solution {
	//@ requires(*The input integers `n` and `limit` must be positive.*);
	//@ requires(*The value of `n` must be between 1 and 50 (inclusive).*);
	//@ requires(*The value of `limit` must be between 1 and 50 (inclusive).*);
