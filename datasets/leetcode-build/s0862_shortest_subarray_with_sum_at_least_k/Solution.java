...
public class Solution {
	...
	//@ requires(*The elements in the input array `nums` must be within the range of -10^5 to 10^5.*);
	//@ requires(*The input integer `k` must be within the range of 1 to 10^9.*);
