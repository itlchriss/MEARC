...
public class Solution {
	...
	//@ requires(*The elements in the input list `nums` are integers.*);
	//@ requires(*The elements in the input list `nums` are greater than or equal to 1.*);
	//@ requires(*The elements in the input list `nums` are less than or equal to 10^9.*);
