...
public class Solution {
    ...
    private int[] next;
	//@ requires(*The length of `s1` is equal to `n`*);
	//@ requires(*The length of `s2` is equal to `n`*);
	//@ requires(*`s1` is alphabetically less than or equal to `s2`*);
	//@ requires(*The length of `evil` is greater than or equal to 1*);
	//@ requires(*All strings consist of lowercase English letters*);
	//@ ensures(*The method returns the number of good strings as an integer*);
	//@ ensures(*The answer is modulo 10^9 + 7*);
