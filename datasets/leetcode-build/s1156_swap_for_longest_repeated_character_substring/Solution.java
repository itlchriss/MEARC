...
public class Solution {
	...
	//@ requires(*2. The length of the input string `text` is greater than or equal to 1.*);
	//@ requires(*3. The input string `text` consists of lowercase English characters only.*);
