...
public class Solution {
	...
	//@ requires(*The length of the input array `obstacles` is equal to `n + 1`.*);
	//@ requires(*The value of `n` is greater than or equal to - The values in the input array `obstacles` range from 0 to - The first and last elements of the input array `obstacles` are both*);
