...
public class Solution {
	//@ requires(*The input sequence and word are not null.*);
	//@ requires(*The input sequence and word are not empty.*);
	//@ requires(*The length of the input sequence is between 1 and 100 (inclusive).*);
	//@ requires(*The length of the input word is between 1 and 100 (inclusive).*);
	//@ requires(*The input sequence and word contain only lowercase English letters.*);
