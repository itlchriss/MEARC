...
public class Solution {
	//@ requires(*The lengths of the arrays `fronts` and `backs` are equal.*);
	//@ requires(*The length of the arrays `fronts` and `backs` is at least 1.*);
	//@ requires(*The length of the arrays `fronts` and `backs` is at most 1000.*);
	//@ requires(*The values in the arrays `fronts` and `backs` are positive integers.*);
	//@ requires(*The values in the arrays `fronts` and `backs` are at most 2000.*);
