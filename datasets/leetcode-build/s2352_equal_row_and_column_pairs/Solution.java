...
public class Solution {
	...
	//@ requires(*The matrix `grid` is 0-indexed.*);
	//@ requires(*The length of each row in `grid` is equal to the length of `grid`.*);
	//@ requires(*The length of `grid` is greater than or equal to 1 and less than or equal to 200.*);
	//@ requires(*Each element in `grid` is an integer greater than or equal to 1 and less than or equal to 10^5.*);
