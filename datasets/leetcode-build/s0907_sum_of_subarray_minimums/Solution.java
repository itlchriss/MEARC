...
public class Solution {
	...
	//@ requires(*Each element in the input array `arr` is greater than or equal to 1.*);
	//@ requires(*Each element in the input array `arr` is less than or equal to 30000.*);
	//@ ensures(*The method returns an integer.*);
	//@ ensures(*The returned integer is the sum of the minimum values of all contiguous subarrays of the input array `arr`.*);
	//@ ensures(*The returned integer is modulo 1000000007.*);
