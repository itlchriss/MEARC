...
public class Solution {
	//@ requires(*The input arrays `dist` and `speed` are not null.*);
	//@ requires(*The lengths of the input arrays `dist` and `speed` are equal.*);
	//@ requires(*The length of the input arrays `dist` and `speed` is at least 1.*);
	//@ requires(*The elements in the input array `dist` are positive integers.*);
	//@ requires(*The elements in the input array `speed` are positive integers.*);
