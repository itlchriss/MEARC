...
//@ ensures(*The integer matrix result has the same dimensions as the integer matrix parameter `matrix`.*);
//@ ensures(*For each cell in the integer matrix result, the value is the floor of the average of the cell and its surrounding cells, considering only the cells that are present.*);
