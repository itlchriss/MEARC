...
//@ ensures(*The lengths of `target` and `arr` are equal.*);
//@ ensures(*The length of `target` and `arr` is at least 1.*);
//@ ensures(*The elements of `target` and `arr` are integers.*);
//@ ensures(*The elements of `target` and `arr` are between 1 and 1000 (inclusive).*);
//@ ensures(**);
