...
//@ ensures(*The length of the input array `points` is greater than or equal to 2.*);
//@ ensures(*Each element in the input array `points` is not null.*);
//@ ensures(*Each element in the input array `points` has a length of 2.*);
//@ ensures(*The coordinates of each point in the input array `points` are integers.*);
//@ ensures(*The coordinates of each point in the input array `points` are within the range of -1000 to 1000.*);
//@ ensures(**);
