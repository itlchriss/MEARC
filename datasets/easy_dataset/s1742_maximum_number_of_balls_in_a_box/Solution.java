...
//@ ensures(*The method takes two integer parameters `lowLimit` and `highLimit`.*);
//@ ensures(*The value of `lowLimit` is greater than or equal to 1.*);
//@ ensures(*The value of `highLimit` is greater than or equal to `lowLimit`.*);
//@ ensures(*The value of `highLimit` is less than or equal to 10^5.*);
//@ ensures(**);
