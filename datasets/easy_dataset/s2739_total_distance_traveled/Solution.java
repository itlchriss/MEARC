...
//@ ensures(*The values of `mainTank` and `additionalTank` must be integers.*);
//@ ensures(*The values of `mainTank` and `additionalTank` must be between 1 and 100 (inclusive).*);
//@ ensures(**);
