...
//@ ensures(*The input arrays `nums1`, `nums2`, and `nums3` must not be null.*);
//@ ensures(*The lengths of `nums1`, `nums2`, and `nums3` must be greater than or equal to 1.*);
//@ ensures(*The lengths of `nums1`, `nums2`, and `nums3` must be less than or equal to 100.*);
//@ ensures(*The elements in `nums1`, `nums2`, and `nums3` must be integers.*);
//@ ensures(*The elements in `nums1`, `nums2`, and `nums3` must be between 1 and 100 (inclusive).*);
//@ ensures(**);
