...
//@ ensures(*The input string `number` must be a positive integer.*);
//@ ensures(*The character `digit` must be a digit from `'1'` to `'9'`.*);
//@ ensures(*The character `digit` must occur at least once in the string `number`.*);
//@ ensures(**);
