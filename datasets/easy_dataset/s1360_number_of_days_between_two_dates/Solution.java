...
//@ ensures(*1. The input strings `date1` and `date2` must be in the format `YYYY-MM-DD`.*);
//@ ensures(*2. The input strings `date1` and `date2` must represent valid dates between the years 1971 and 2100.*);
//@ ensures(**);
