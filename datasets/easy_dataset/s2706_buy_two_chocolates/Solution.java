...
//@ ensures(*The prices array must have at least 2 elements.*);
//@ ensures(*Each element in the prices array must be between 1 and 100 (inclusive).*);
//@ ensures(*The money value must be between 1 and 100 (inclusive).*);
//@ ensures(**);
