...
//@ ensures(*The input matrix is a 2D array of distinct numbers.*);
//@ ensures(*The matrix has at least one row and one column.*);
//@ ensures(*The number of rows and columns in the matrix is between 1 and 50 (inclusive).*);
//@ ensures(*The values in the matrix are between 1 and 10^5 (inclusive).*);
//@ ensures(**);
