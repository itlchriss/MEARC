...
//@ ensures(*The length of `words` is at least 3.*);
//@ ensures(*All strings in `words` have the same length `n`.*);
//@ ensures(*The length `n` of each string in `words` is at least 2 and at most 20.*);
//@ ensures(*Each string in `words` consists of lowercase English letters.*);
//@ ensures(**);
