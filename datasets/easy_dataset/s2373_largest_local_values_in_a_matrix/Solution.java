...
//@ ensures(*The size of `grid` is at least 3x3 (i.e., `n >= 3`).*);
//@ ensures(*The values in `grid` are integers.*);
//@ ensures(*The values in `grid` are within the range of 1 to 100 (inclusive).*);
//@ ensures(**);
