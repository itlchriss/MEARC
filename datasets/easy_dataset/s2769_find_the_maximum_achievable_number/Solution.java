...
//@ ensures(*The method takes two integer parameters, `num` and `t`.*);
//@ ensures(*`num` is a positive integer greater than or equal to 1.*);
//@ ensures(*`t` is a positive integer greater than or equal to 1.*);
//@ ensures(**);
