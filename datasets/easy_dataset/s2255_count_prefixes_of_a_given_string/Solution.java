...
//@ ensures(*The length of `words` is greater than or equal to - The length of each string in `words` is greater than or equal to - The length of `s` is greater than or equal to - Each string in `words` and `s` consists only of lowercase English letters.*);
//@ ensures(**);
