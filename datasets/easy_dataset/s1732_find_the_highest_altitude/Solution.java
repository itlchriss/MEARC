...
//@ ensures(*The input array `gain` is not null.*);
//@ ensures(*The length of the input array `gain` is greater than or equal to 1.*);
//@ ensures(*The length of the input array `gain` is less than or equal to 100.*);
//@ ensures(*Each element in the input array `gain` is an integer.*);
//@ ensures(*Each element in the input array `gain` is within the range of -100 to 100.*);
//@ ensures(**);
