...
//@ ensures(*The `sentence` string is not null.*);
//@ ensures(*The `searchWord` string is not null.*);
//@ ensures(*The `sentence` string consists of lowercase English letters and spaces.*);
//@ ensures(*The `searchWord` string consists of lowercase English letters.*);
//@ ensures(*The length of the `sentence` string is between 1 and 100.*);
//@ ensures(*The length of the `searchWord` string is between 1 and 10.*);
//@ ensures(**);
