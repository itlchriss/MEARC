...
//@ ensures(*The input `title` is a non-empty string.*);
//@ ensures(*The input `title` consists of one or more words separated by a single space.*);
//@ ensures(*Each word in the input `title` consists of English letters.*);
//@ ensures(*The length of each word in the input `title` is at least 1.*);
//@ ensures(**);
