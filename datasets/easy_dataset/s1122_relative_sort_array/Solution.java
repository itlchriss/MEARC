...
//@ ensures(*The lengths of `arr1` and `arr2` are between 1 and 1000, inclusive.*);
//@ ensures(*The elements of `arr2` are distinct.*);
//@ ensures(*Each element in `arr2` is also present in `arr1`.*);
//@ ensures(**);
