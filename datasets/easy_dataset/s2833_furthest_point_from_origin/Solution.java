...
//@ ensures(*The input string `moves` is not null.*);
//@ ensures(*The length of the input string `moves` is greater than or equal to 1 and less than or equal to 50.*);
//@ ensures(*The input string `moves` consists only of characters `'L'`, `'R'`, and `'_'`.*);
//@ ensures(**);
