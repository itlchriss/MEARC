...
//@ ensures(*The input sentence is a string.*);
//@ ensures(*The sentence consists of only uppercase and lowercase English letters and spaces.*);
//@ ensures(*The words in the sentence are separated by a single space.*);
