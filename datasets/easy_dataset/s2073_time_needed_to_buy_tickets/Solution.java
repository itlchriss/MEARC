...
//@ ensures(*The input array `tickets` must not be null.*);
//@ ensures(*The length of the input array `tickets` must be equal to `n`.*);
//@ ensures(*The value of `n` must be greater than or equal to 1.*);
//@ ensures(*The value of `k` must be greater than or equal to 0 and less than `n`.*);
//@ ensures(**);
