...
public class StringTest
{
    ...
    public void getBytes(String s, int srcBegin, int srcEnd, byte[] dst, int dstBegin)
      throws StringIndexOutOfBoundsException {
    ...
    // no such method 
    // public static int indexOf(String s, char[] source, int sourceOffset, int sourceCount, char[] target, int targetOffset, int targetCount, int fromIndex) {
    //   return s.indexOf(source, sourceOffset, sourceCount, target, targetOffset, targetCount, fromIndex);
    // }
    ...
    // public static int lastIndexOf(String s, char[] source, int sourceOffset, int sourceCount, char[] target, int targetOffset, int targetCount, int fromIndex) {
    //   return s.lastIndexOf(source, sourceOffset, sourceCount, target, targetOffset, targetCount, fromIndex);
    // }
    ...
    // public static String valueOf(String s, boolean b) {
    //   return s.valueOf(b);
    // }
    ...
    // public static String valueOf(String s, int i) {
    //   return s.valueOf(i);
    // }
    

    // public static String valueOf(String s, long l) {
    //   return s.valueOf(l);
    // }
    

    // public static String valueOf(String s, float f) {
    //   return s.valueOf(f);
    // }
    ...
    // public native String intern(String s) {
    //   return s.intern();
    // }
