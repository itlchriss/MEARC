...
//@ ensures(*If the string parameter `needle` is not found in the string parameter `haystack`, the integer result is equal to -1.*);
//@ ensures(*If the string parameter `needle` is found in the string parameter `haystack`, the integer result is equal to the index of the first occurrence of `needle` in `haystack`.*);
