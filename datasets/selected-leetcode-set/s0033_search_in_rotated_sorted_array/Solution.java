...
//@ ensures(*If the integer result is greater than or equal to 0, the integer array parameter `nums` contains the integer parameter `target`.*);
//@ ensures(*If the integer result is equal to -1, the integer array parameter `nums` does not contain the integer parameter `target`.*);
