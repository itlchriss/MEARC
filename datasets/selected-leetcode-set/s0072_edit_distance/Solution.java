...
//@ requires(*The length of the string parameter `w1` and the string parameter `w2` is less than or equal to 500 and is greater than or equal to 0.*);
//@ requires(*All characters in the string parameter `w1` and the string parameter `w2` are lowercase English letters.*);
