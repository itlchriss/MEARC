...
//@ ensures(*The boolean result is equal to true if the integer parameter `n` is an ugly number.*);
//@ ensures(*The boolean result is equal to false if the integer parameter `n` is not an ugly number.*);
