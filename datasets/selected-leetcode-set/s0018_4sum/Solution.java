...
//@ ensures(*The sum of the values in each integer array in the list result is equal to the integer parameter `target`.*);
//@ ensures(*The list result contains unique quadruplets.*);
