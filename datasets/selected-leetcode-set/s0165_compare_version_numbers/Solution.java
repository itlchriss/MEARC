...
//@ requires(*All the revisions in the string parameters `version1` and `version2` can be stored in a 32-bit integer.*);
//@ ensures(*If the string parameter `version1` is less than the string parameter `version2`, the integer result is equal to -1.*);
//@ ensures(*If the string parameter `version1` is greater than the string parameter `version2`, the integer result is equal to 1.*);
//@ ensures(*If the string parameter `version1` is equal to the string parameter `version2`, the integer result is equal to 0.*);
