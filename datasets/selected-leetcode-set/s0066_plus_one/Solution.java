...
//@ ensures(*If all elements of the integer array parameter `digits` are equal to 9, the first element of the integer array result is equal to 1 and all other elements are equal to 0.*);
