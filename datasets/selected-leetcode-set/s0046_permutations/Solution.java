...
//@ ensures(*Each element in the list result is a list of integers.*);
//@ ensures(*Each list of integers in the list result is a permutation of the integer array parameter `nums`.*);
