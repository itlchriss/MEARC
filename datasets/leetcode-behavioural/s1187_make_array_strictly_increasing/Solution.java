...
//@ ensures(*The lengths of `arr1` and `arr2` are both between 1 and 2000, inclusive.*);
//@ ensures(*The elements of `arr1` and `arr2` are integers between 0 and 10^9, inclusive.*);
//@ ensures(**);
