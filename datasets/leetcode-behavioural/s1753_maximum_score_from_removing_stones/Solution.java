...
//@ ensures(*The method takes three integer parameters `a`, `b`, and `c`.*);
//@ ensures(*The values of `a`, `b`, and `c` are positive integers.*);
//@ ensures(*The values of `a`, `b`, and `c` are less than or equal to 10^5.*);
//@ ensures(**);
