...
//@ ensures(*The input array `bloomDay` is not null.*);
//@ ensures(*The length of `bloomDay` is equal to `n`.*);
//@ ensures(*The elements of `bloomDay` are positive integers.*);
//@ ensures(*The value of `n` is between 1 and 10^5 (inclusive).*);
//@ ensures(*The value of `m` is between 1 and 10^6 (inclusive).*);
//@ ensures(*The value of `k` is between 1 and `n` (inclusive).*);
//@ ensures(**);
