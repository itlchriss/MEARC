...
//@ ensures(*The boolean result is true if the string parameter `word` exists in the character array parameter `board`.*);
...
//@ ensures(*The same letter cell may not be used more than once.*);
