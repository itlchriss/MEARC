...
//@ ensures(*The input array `costs` has at least one element.*);
//@ ensures(*The input array `costs` contains positive integers.*);
//@ ensures(*The input integer `coins` is positive.*);
//@ ensures(**);
