...
//@ ensures(*The length of the input array `nums` is equal to `2 * n`.*);
//@ ensures(*The value of `n` is greater than or equal to 1 and less than or equal to 15.*);
//@ ensures(*The values in the input array `nums` are integers.*);
//@ ensures(*The values in the input array `nums` are within the range of -10^7 to 10^7.*);
//@ ensures(**);
