...
//@ ensures(*The returned index `i` is the smallest index at which the array can be split validly.*);
//@ ensures(*The returned index `i` is -1 if there is no valid split.*);
