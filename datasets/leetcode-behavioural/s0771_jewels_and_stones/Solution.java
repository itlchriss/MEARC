...
//@ ensures(*1. The input strings `jewels` and `stones` must not be null.*);
//@ ensures(*2. The length of `jewels` and `stones` must be between 1 and 50.*);
//@ ensures(*3. The characters in `jewels` must be unique.*);
//@ ensures(**);
