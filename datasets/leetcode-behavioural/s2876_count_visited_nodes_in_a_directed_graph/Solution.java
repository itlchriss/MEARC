...
//@ ensures(*The input `edges` is not null.*);
//@ ensures(*The length of `edges` is equal to `n`.*);
//@ ensures(*The values in `edges` are between 0 and `n-1`.*);
//@ ensures(*The values in `edges` are distinct.*);
//@ ensures(**);
