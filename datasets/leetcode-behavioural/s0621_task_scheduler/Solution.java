...
//@ ensures(*The character array parameter `tasks` must not be null.*);
//@ ensures(*The integer parameter `n` must be non-negative.*);
//@ ensures(*The integer result is the least number of units of time that the CPU will take to finish all the given tasks.*);
