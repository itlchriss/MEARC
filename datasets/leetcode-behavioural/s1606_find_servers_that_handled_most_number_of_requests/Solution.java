...
//@ ensures(*The `id` parameter must be a non-negative integer.*);
//@ ensures(*The `busyTime` parameter must be a non-negative integer.*);
//@ ensures(*The `arrival` array must be a strictly increasing array of positive integers.*);
//@ ensures(*The `load` array must have the same length as the `arrival` array.*);
//@ ensures(*The `load` array must contain positive integers.*);
//@ ensures(**);
