...
//@ ensures(*The length of the input array `arr` is at least 3.*);
//@ ensures(*The elements in the input array `arr` are strictly increasing.*);
//@ ensures(*The elements in the input array `arr` are positive integers.*);
//@ ensures(*The maximum value of the elements in the input array `arr` is less than or equal to 10^9.*);
//@ ensures(**);
