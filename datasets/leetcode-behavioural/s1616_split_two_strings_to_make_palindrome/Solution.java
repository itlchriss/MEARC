...
//@ ensures(*The lengths of `a` and `b` are equal.*);
//@ ensures(*The lengths of `a` and `b` are between 1 and 10^5 (inclusive).*);
//@ ensures(*`a` and `b` consist of lowercase English letters.*);
//@ ensures(**);
