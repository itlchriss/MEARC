...
//@ ensures(*The input grid must be a 2D array of positive integers.*);
//@ ensures(*The grid must have at least 2 rows and 2 columns.*);
//@ ensures(*The grid must have at most 1000 rows and 1000 columns.*);
//@ ensures(*The total number of cells in the grid must be between 4 and 10^5.*);
//@ ensures(*The values in the grid must be between 1 and 10^6.*);
//@ ensures(**);
