...
//@ ensures(*The input array `price` is not null.*);
//@ ensures(*The length of the input array `price` is greater than or equal to `k`.*);
//@ ensures(*The input integer `k` is greater than or equal to 2.*);
//@ ensures(*The input integer `k` is less than or equal to the length of the input array `price`.*);
//@ ensures(*The elements in the input array `price` are positive integers.*);
//@ ensures(*The elements in the input array `price` are distinct.*);
//@ ensures(**);
