...
//@ ensures(*2. The input string `s` contains only lowercase English letters.*);
//@ ensures(*3. The input integer `k` is greater than or equal to 1.*);
//@ ensures(*4. The length of the input string `s` is greater than or equal to `k`.*);
//@ ensures(**);
