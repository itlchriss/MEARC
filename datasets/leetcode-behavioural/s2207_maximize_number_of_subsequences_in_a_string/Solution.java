...
//@ ensures(*The input strings `text` and `pattern` are not null.*);
//@ ensures(*The length of `text` is at least 1 and at most 10^5.*);
//@ ensures(*The length of `pattern` is exactly 2.*);
//@ ensures(*`text` and `pattern` consist only of lowercase English letters.*);
//@ ensures(**);
