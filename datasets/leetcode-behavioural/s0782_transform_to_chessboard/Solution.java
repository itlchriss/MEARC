...
//@ ensures(*The input `board` is a square binary grid with dimensions `n x n`.*);
//@ ensures(*The value of `n` is between 2 and 30 (inclusive).*);
//@ ensures(*Each element in the `board` is either 0 or 1.*);
//@ ensures(**);
