...
//@ ensures(*Each value in the grid represents the elevation at a specific point.*);
//@ ensures(*The rain starts to fall and the depth of the water everywhere is t.*);
//@ ensures(*You can swim from a square to another 4-directionally adjacent square if and only if the elevation of both squares individually are at most t.*);
//@ ensures(*You must stay within the boundaries of the grid during your swim.*);
//@ ensures(**);
