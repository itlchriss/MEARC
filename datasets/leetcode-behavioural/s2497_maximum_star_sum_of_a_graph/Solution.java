...
//@ ensures(*The input array `nodeValues` must not be null.*);
//@ ensures(*The length of the input array `nodeValues` must be equal to `n`.*);
//@ ensures(*The input array `edges` must not be null.*);
//@ ensures(*The length of the input array `edges` must be equal to the number of edges in the graph.*);
//@ ensures(*The input integer `maxNumberOfEdges` must be non-negative.*);
//@ ensures(**);
