...
//@ ensures(*The lengths of the `scores` and `ages` arrays must be the same.*);
//@ ensures(*The length of the `scores` and `ages` arrays must be between 1 and - Each element in the `scores` array must be between 1 and 10^- Each element in the `ages` array must be between 1 and *);
