...
//@ ensures(*The lengths of `s` and `t` are both greater than or equal to 1.*);
//@ ensures(*The lengths of `s` and `t` are both less than or equal to 2 * 10^5.*);
//@ ensures(*`s` and `t` consist of lowercase English letters.*);
//@ ensures(**);
