...
//@ ensures(*The input lists `processorTime` and `tasks` must not be null.*);
//@ ensures(*The length of `processorTime` must be equal to the length of `tasks`.*);
//@ ensures(*The length of `processorTime` must be equal to `4 * n`.*);
//@ ensures(*The values in `processorTime` must be non-negative integers.*);
//@ ensures(*The values in `tasks` must be positive integers.*);
//@ ensures(**);
