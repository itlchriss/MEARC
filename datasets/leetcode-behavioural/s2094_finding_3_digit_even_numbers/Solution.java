...
//@ ensures(*The input array `digits` must have a length greater than or equal to 3.*);
//@ ensures(*Each element in the `digits` array must be an integer between 0 and 9 (inclusive).*);
//@ ensures(**);
