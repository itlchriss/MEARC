...
//@ ensures(*The length of `nums` is greater than or equal to 1 and less than or equal to 10^5.*);
//@ ensures(*Each element in `nums` is a positive integer greater than or equal to 1 and less than or equal to 10^9.*);
//@ ensures(*The value of `k` is a positive integer greater than or equal to 1 and less than or equal to 10^8.*);
//@ ensures(**);
