...
//@ ensures(*The input array `rating` is not null.*);
//@ ensures(*The length of the input array `rating` is at least 3.*);
//@ ensures(*The integers in the input array `rating` are unique.*);
//@ ensures(**);
