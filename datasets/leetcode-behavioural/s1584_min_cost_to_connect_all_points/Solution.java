...
//@ ensures(*The coordinates `x` and `y` of each point in the input array `points` are within the range of -10^6 to 10^6.*);
//@ ensures(*All pairs of coordinates `(x, y)` in the input array `points` are distinct.*);
//@ ensures(**);
