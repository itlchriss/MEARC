...
//@ ensures(*The input array `fruits` is not null.*);
//@ ensures(*The length of the input array `fruits` is greater than or equal to 1.*);
//@ ensures(*The elements in the input array `fruits` are non-negative integers.*);
//@ ensures(*The elements in the input array `fruits` are less than the length of the input array `fruits`.*);
//@ ensures(**);
