...
//@ ensures(*The length of the input array `time` is at least 1 and at most 6 * 10^- Each element in the input array `time` is an integer between 1 and 500 (inclusive).*);
//@ ensures(**);
