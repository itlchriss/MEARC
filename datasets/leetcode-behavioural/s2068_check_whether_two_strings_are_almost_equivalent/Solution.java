...
//@ ensures(*The input strings `word1` and `word2` must not be null.*);
//@ ensures(*The lengths of `word1` and `word2` must be equal.*);
//@ ensures(*The lengths of `word1` and `word2` must be between 1 and 100 (inclusive).*);
//@ ensures(*`word1` and `word2` must consist only of lowercase English letters.*);
//@ ensures(**);
