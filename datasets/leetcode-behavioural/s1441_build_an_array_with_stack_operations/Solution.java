...
//@ ensures(*The `target` array is not null.*);
//@ ensures(*The `target` array is strictly increasing.*);
//@ ensures(*The length of the `target` array is between 1 and 100 (inclusive).*);
//@ ensures(*The value of `n` is between 1 and 100 (inclusive).*);
//@ ensures(*Each element in the `target` array is between 1 and `n` (inclusive).*);
//@ ensures(**);
