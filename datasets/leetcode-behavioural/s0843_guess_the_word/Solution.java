...
//@ ensures(*The `wordlist` array must have at least one element.*);
//@ ensures(*Each string in the `wordlist` array must be 6 letters long.*);
//@ ensures(*The `secret` word must exist in the `wordlist` array.*);
//@ ensures(*The `numguesses` must be equal to 10.*);
//@ ensures(**);
