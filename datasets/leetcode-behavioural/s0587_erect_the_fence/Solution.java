...
//@ ensures(*The integer 2D array parameter `trees` must not be null.*);
//@ ensures(*The integer 2D array result contains the coordinates of trees that are exactly located on the fence perimeter.*);
