...
//@ ensures(*Each interval in `intervals` is an array of length 2.*);
//@ ensures(*The first element of each interval is less than the second element.*);
//@ ensures(*The intervals in `intervals` are unique.*);
//@ ensures(**);
