...
//@ ensures(*The length of `events` is at least 2.*);
//@ ensures(*Each event in `events` is represented by an array of length 3.*);
//@ ensures(*The start time of each event is less than or equal to the end time.*);
//@ ensures(*The start time and end time of each event are positive integers.*);
