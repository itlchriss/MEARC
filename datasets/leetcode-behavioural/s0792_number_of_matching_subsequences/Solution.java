...
//@ ensures(*The length of `s` is between 1 and 5 * 10^4.*);
//@ ensures(*The length of `words` is between 1 and 5000.*);
//@ ensures(*Each string in `words` has a length between 1 and 50.*);
//@ ensures(*`s` and each string in `words` consist of only lowercase English letters.*);
//@ ensures(**);
