...
//@ ensures(*The input array `ranks` must not be null.*);
//@ ensures(*The length of the input array `ranks` must be greater than or equal to 1.*);
//@ ensures(*The elements in the input array `ranks` must be positive integers.*);
//@ ensures(*The input integer `cars` must be greater than or equal to 1.*);
//@ ensures(**);
