...
//@ ensures(*The integer 2D array parameter `points` must not be null.*);
//@ ensures(*The integer result is the number of boomerangs formed by the points in the integer 2D array parameter `points`.*);
...
//@ ensures(*The order of the tuple matters in determining a boomerang.*);
