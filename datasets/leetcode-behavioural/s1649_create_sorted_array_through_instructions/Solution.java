...
//@ ensures(*The input array `instructions` is not null.*);
//@ ensures(*The length of the input array `instructions` is greater than or equal to 1.*);
//@ ensures(*Each element in the input array `instructions` is an integer.*);
//@ ensures(*Each element in the input array `instructions` is greater than or equal to 1.*);
//@ ensures(*Each element in the input array `instructions` is less than or equal to 10^5.*);
//@ ensures(**);
