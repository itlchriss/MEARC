...
//@ ensures(*The string parameter `digits` must only contain digits from '2' to '9'.*);
//@ ensures(*The size of the string collection result is equal to the number of possible letter combinations that the input number could represent.*);
//@ ensures(*Each element in the string collection result is a combination of letters corresponding to the input number.*);
