...
//@ ensures(*The integer parameter `maxWidth` must be greater than 0.*);
//@ ensures(*The size of the string collection result is less than or equal to the size of the string array parameter `words`.*);
//@ ensures(*Each line in the string collection result has exactly `maxWidth` characters.*);
//@ ensures(*Extra spaces between words are distributed as evenly as possible.*);
