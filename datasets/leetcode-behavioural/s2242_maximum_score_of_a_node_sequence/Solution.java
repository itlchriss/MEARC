...
//@ ensures(*The input array `scores` is not null.*);
//@ ensures(*The input array `edges` is not null.*);
//@ ensures(*The length of the input array `scores` is equal to `n`.*);
//@ ensures(*The length of the input array `edges` is not greater than `5 * 10^4`.*);
//@ ensures(*Each element in the input array `edges` is an array of length - The values in the input array `edges` are valid node indices, i.e., between `0` and `n - 1`.*);
//@ ensures(*The values in the input array `scores` are valid scores, i.e., between `1` and `10^8`.*);
//@ ensures(**);
