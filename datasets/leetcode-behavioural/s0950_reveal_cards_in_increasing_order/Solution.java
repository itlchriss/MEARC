...
//@ ensures(*The length of `deck` is at least 1 and at most 1000.*);
//@ ensures(*Each element in `deck` is an integer between 1 and 10^6 (inclusive).*);
//@ ensures(*All the values in `deck` are unique.*);
//@ ensures(**);
