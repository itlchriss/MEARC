...
//@ ensures(*The input arrays `aliceValues` and `bobValues` are not null.*);
//@ ensures(*The length of `aliceValues` is equal to the length of `bobValues`.*);
//@ ensures(*The length of `aliceValues` is greater than 0.*);
//@ ensures(*The values in `aliceValues` and `bobValues` are integers.*);
//@ ensures(*The values in `aliceValues` and `bobValues` are between 1 and 100 (inclusive).*);
//@ ensures(**);
