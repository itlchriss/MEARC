...
//@ ensures(*The length of the input array `nums` is less than or equal to 1000.*);
//@ ensures(*Each element in the input array `nums` is a non-negative integer.*);
//@ ensures(*Each element in the input array `nums` is less than 2^16.*);
//@ ensures(**);
