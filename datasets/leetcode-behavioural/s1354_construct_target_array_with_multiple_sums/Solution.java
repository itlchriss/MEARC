...
//@ ensures(*The input array `target` is not null.*);
//@ ensures(*The length of the input array `target` is greater than 0.*);
//@ ensures(*The length of the input array `target` is less than or equal to 5 * 10^4.*);
//@ ensures(*Each element in the input array `target` is greater than or equal to 1.*);
//@ ensures(*Each element in the input array `target` is less than or equal to 10^9.*);
//@ ensures(**);
