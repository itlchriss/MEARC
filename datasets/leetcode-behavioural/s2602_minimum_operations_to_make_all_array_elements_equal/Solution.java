...
//@ ensures(*The length of `queries` is equal to `m`.*);
//@ ensures(*The elements of `nums` are positive integers.*);
//@ ensures(*The elements of `queries` are positive integers.*);
//@ ensures(*`n` and `m` are both greater than or equal to 1.*);
//@ ensures(*The maximum value of `n` is 10^5.*);
//@ ensures(*The maximum value of `m` is 10^5.*);
//@ ensures(*The maximum value of each element in `nums` is 10^9.*);
//@ ensures(*The maximum value of each element in `queries` is 10^9.*);
//@ ensures(**);
