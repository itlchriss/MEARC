...
//@ ensures(*The input `folder` is not null.*);
//@ ensures(*The length of `folder` is greater than or equal to 1.*);
//@ ensures(*Each element in `folder` is a valid path, starting with a '/' and consisting of one or more lowercase English letters.*);
//@ ensures(**);
