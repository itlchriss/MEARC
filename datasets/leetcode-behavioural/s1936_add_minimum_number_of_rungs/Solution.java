...
//@ ensures(*The input array `rungs` is not null.*);
//@ ensures(*The input array `rungs` is strictly increasing.*);
//@ ensures(*The input integer `dist` is greater than or equal to 1.*);
//@ ensures(**);
