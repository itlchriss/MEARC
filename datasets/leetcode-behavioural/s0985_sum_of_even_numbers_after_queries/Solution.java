...
//@ ensures(*The length of `nums` must be greater than or equal to 1.*);
//@ ensures(*The length of `queries` must be greater than or equal to 1.*);
//@ ensures(*The values in `nums` must be within the range of -10^4 to 10^4.*);
//@ ensures(*The values in `queries` must be within the range of -10^4 to 10^4.*);
//@ ensures(*The indices in `queries` must be within the range of 0 to the length of `nums` minus 1.*);
//@ ensures(**);
