...
//@ ensures(*The length of `s1` is equal to `n`*);
//@ ensures(*The length of `s2` is equal to `n`*);
//@ ensures(*`s1` is alphabetically less than or equal to `s2`*);
//@ ensures(*The length of `evil` is greater than or equal to 1*);
//@ ensures(*All strings consist of lowercase English letters*);
//@ ensures(**);
