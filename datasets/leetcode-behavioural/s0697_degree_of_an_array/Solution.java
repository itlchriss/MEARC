...
public class Solution {
    private static class Value {
        ...
        int start;
        int end;
//@ ensures(*The integer array parameter `nums` must not be empty.*);
//@ ensures(*The integer result is the smallest possible length of a contiguous subarray of `nums` that has the same degree as `nums`.*);
