...
//@ ensures(*The input string `paragraph` is not null.*);
//@ ensures(*The input string array `banned` is not null.*);
//@ ensures(*The length of `paragraph` is between 1 and 1000.*);
//@ ensures(*The length of each string in `banned` is between 1 and 10.*);
//@ ensures(*The elements in `banned` consist of only lowercase English letters.*);
//@ ensures(**);
