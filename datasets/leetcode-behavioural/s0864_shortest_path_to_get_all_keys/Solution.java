...
//@ ensures(*3. The input grid must contain only valid characters: '.', '#', '@', lowercase letters, and uppercase letters.*);
//@ ensures(*4. The number of keys in the grid must be between 1 and 6 (inclusive).*);
//@ ensures(*5. Each key in the grid must have a matching lock.*);
//@ ensures(**);
