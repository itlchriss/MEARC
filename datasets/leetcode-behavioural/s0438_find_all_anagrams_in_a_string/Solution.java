...
//@ ensures(*The integer collection result contains the start indices of `p`'s anagrams in `s`.*);
//@ ensures(*The order of the start indices in the integer collection result can be arbitrary.*);
