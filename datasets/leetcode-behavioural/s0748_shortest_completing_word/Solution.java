...
//@ ensures(*The input string `licensePlate` is not null.*);
//@ ensures(*The input array `words` is not null.*);
//@ ensures(*The length of `licensePlate` is between 1 and 7 (inclusive).*);
//@ ensures(*The length of each word in `words` is between 1 and 15 (inclusive).*);
//@ ensures(*Each word in `words` consists of lowercase English letters.*);
//@ ensures(**);
