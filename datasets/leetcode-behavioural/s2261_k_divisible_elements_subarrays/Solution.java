...
//@ ensures(*The length of `nums` is greater than or equal to 1 and less than or equal to 200.*);
//@ ensures(*Each element in `nums` is greater than or equal to 1 and less than or equal to 200.*);
//@ ensures(*The value of `k` is greater than or equal to 1 and less than or equal to the length of `nums`.*);
//@ ensures(*The value of `p` is greater than or equal to 1 and less than or equal to 200.*);
//@ ensures(**);
