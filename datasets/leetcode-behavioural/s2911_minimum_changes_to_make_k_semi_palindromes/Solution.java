...
//@ ensures(*The input string `s` has a length greater than or equal to 2.*);
//@ ensures(*The input integer `k` is greater than or equal to 1 and less than or equal to half the length of `s`.*);
//@ ensures(**);
