...
//@ ensures(*The length of `nums` and `divisors` is at least 1.*);
//@ ensures(*The length of `nums` and `divisors` is at most 1000.*);
//@ ensures(*The elements of `nums` and `divisors` are integers.*);
//@ ensures(*The elements of `nums` and `divisors` are at least 1.*);
//@ ensures(*The elements of `nums` and `divisors` are at most 10^9.*);
//@ ensures(**);
