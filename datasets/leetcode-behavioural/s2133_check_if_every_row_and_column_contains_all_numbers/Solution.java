...
//@ ensures(*The input matrix must not be null.*);
//@ ensures(*The input matrix must be a square matrix (n x n).*);
//@ ensures(*The values in the input matrix must be integers.*);
//@ ensures(*The values in the input matrix must be within the range of 1 to n (inclusive).*);
//@ ensures(**);
