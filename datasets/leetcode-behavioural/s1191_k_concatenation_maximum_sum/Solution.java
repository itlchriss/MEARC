...
//@ ensures(*The length of the input array `arr` must be greater than or equal to 1.*);
//@ ensures(*The value of `k` must be greater than or equal to 1.*);
//@ ensures(*The value of `k` must be less than or equal to 100,000.*);
//@ ensures(*The length of the input array `arr` must be less than or equal to 100,000.*);
//@ ensures(*Each element in the input array `arr` must be an integer.*);
//@ ensures(*Each element in the input array `arr` must be between -10,000 and 10,000.*);
//@ ensures(**);
