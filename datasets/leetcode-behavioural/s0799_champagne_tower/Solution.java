...
//@ ensures(*The method takes two integer parameters `queryRow` and `queryGlass` which represent the row and glass indices respectively.*);
//@ ensures(*The method takes an integer parameter `poured` which represents the number of cups of champagne poured.*);
//@ ensures(*The value of `poured` is non-negative.*);
//@ ensures(*The value of `queryRow` is between 0 and 99 (inclusive).*);
//@ ensures(*The value of `queryGlass` is between 0 and `queryRow` (inclusive).*);
//@ ensures(**);
