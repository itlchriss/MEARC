...
//@ ensures(*The method should take two integer parameters `targetX` and `targetY`.*);
//@ ensures(*The values of `targetX` and `targetY` should be between 1 and 10^9 (inclusive).*);
//@ ensures(**);
