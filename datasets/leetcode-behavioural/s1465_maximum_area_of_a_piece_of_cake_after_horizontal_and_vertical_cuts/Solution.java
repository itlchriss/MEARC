...
//@ ensures(*The input values `h` and `w` must be integers greater than or equal to - The arrays `horizontalCuts` and `verticalCuts` must not be null.*);
//@ ensures(*The length of `horizontalCuts` must be greater than or equal to 1 and less than or equal to `h - 1`.*);
//@ ensures(*The length of `verticalCuts` must be greater than or equal to 1 and less than or equal to `w - 1`.*);
//@ ensures(*All elements in `horizontalCuts` must be integers greater than or equal to 1 and less than `h`.*);
//@ ensures(*All elements in `verticalCuts` must be integers greater than or equal to 1 and less than `w`.*);
//@ ensures(*All elements in `horizontalCuts` must be distinct.*);
//@ ensures(*All elements in `verticalCuts` must be distinct.*);
//@ ensures(**);
