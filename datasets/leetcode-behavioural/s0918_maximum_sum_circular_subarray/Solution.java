...
//@ ensures(*3. The length of the input array `nums` is less than or equal to 30,000.*);
//@ ensures(*4. Each element in the input array `nums` is an integer.*);
//@ ensures(*5. Each element in the input array `nums` is within the range of -30,000 to 30,000.*);
//@ ensures(**);
