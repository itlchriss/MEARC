...
//@ ensures(*The input grid is a 2D integer array of size m x n.*);
//@ ensures(*Each cell in the grid has a value of either 0 or 1.*);
//@ ensures(*The upper left corner (0, 0) and the lower right corner (m - 1, n - 1) are both empty cells (0).*);
//@ ensures(**);
