...
//@ ensures(*The input array `strength` is not null.*);
//@ ensures(*The length of the input array `strength` is greater than 0.*);
//@ ensures(*The elements in the input array `strength` are positive integers.*);
//@ ensures(**);
