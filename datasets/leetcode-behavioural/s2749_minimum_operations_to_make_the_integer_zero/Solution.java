...
//@ ensures(*The method takes two integer parameters `num1` and `num2`.*);
//@ ensures(*The value of `num1` is between 1 and 10^9 (inclusive).*);
//@ ensures(*The value of `num2` is between -10^9 and 10^9 (inclusive).*);
//@ ensures(**);
