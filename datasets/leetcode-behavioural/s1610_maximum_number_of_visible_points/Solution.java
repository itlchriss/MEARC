...
//@ ensures(*The input list `points` is not null.*);
//@ ensures(*The input list `points` contains at least one element.*);
//@ ensures(*The input integer `angle` is between 0 and 359 (inclusive).*);
//@ ensures(*The input list `location` is not null.*);
//@ ensures(*The input list `location` contains exactly two elements.*);
//@ ensures(*The input lists `points` and `location` contain only integers.*);
//@ ensures(*The coordinates in the input lists `points` and `location` are between 0 and 100 (inclusive).*);
//@ ensures(**);
