...
//@ ensures(*The length of the input array `nums` must be even.*);
//@ ensures(*The length of the input array `nums` must be equal to `2 * n`.*);
//@ ensures(*The value of `n` must be between 1 and 7 (inclusive).*);
//@ ensures(*Each element in the input array `nums` must be a positive integer.*);
//@ ensures(*Each element in the input array `nums` must be between 1 and 10^6 (inclusive).*);
//@ ensures(**);
