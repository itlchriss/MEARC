...
//@ ensures(*The initial bank account balance is 100 dollars.*);
//@ ensures(*The purchaseAmount is an integer representing the amount to be spent on a purchase in dollars.*);
//@ ensures(*The purchaseAmount is between 0 and 100 (inclusive).*);
//@ ensures(**);
