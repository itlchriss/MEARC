...
//@ ensures(*The integer array result contains the intersection of elements from the integer array parameter `nums1` and the integer array parameter `nums2`.*);
//@ ensures(*Each element in the integer array result appears as many times as it shows in both `nums1` and `nums2`.*);
