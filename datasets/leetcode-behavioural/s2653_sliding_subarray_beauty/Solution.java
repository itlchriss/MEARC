...
//@ ensures(*The value of `x` is greater than or equal to 1 and less than or equal to `k`.*);
//@ ensures(*The elements in the input array `nums` are integers ranging from -50 to 50.*);
//@ ensures(**);
