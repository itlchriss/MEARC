...
//@ ensures(*The length of the input array `arr` is greater than 0.*);
//@ ensures(*The input array `arr` represents a permutation of the integers in the range `[0, n - 1]`.*);
//@ ensures(*All elements in the input array `arr` are unique.*);
//@ ensures(**);
