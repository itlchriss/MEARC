...
//@ ensures(*The input grid size `n` is a positive integer.*);
//@ ensures(*The `artifacts` array is not null and contains valid artifact coordinates.*);
//@ ensures(*The `dig` array is not null and contains valid excavation coordinates.*);
//@ ensures(*The entries of `dig` are unique.*);
//@ ensures(**);
