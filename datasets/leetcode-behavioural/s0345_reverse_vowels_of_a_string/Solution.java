...
//@ ensures(*The string parameter `str` must not be null.*);
//@ ensures(*The string result contains the same characters as the string parameter `str`, with only the vowels reversed.*);
