...
//@ ensures(*The input array `people` is not null.*);
//@ ensures(*The input array `people` has at least one element.*);
//@ ensures(*The input array `people` contains only positive integers.*);
//@ ensures(*The input integer `limit` is greater than or equal to 1.*);
//@ ensures(*The input integer `limit` is less than or equal to 30000.*);
//@ ensures(**);
