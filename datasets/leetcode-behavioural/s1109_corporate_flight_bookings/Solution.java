...
//@ ensures(*The input array `bookings` is not null.*);
//@ ensures(*The length of the input array `bookings` is not zero.*);
//@ ensures(*The value of `n` is greater than or equal to 1.*);
//@ ensures(*The length of each booking in `bookings` is 3.*);
//@ ensures(*The value of `first_i` is greater than or equal to 1.*);
//@ ensures(*The value of `last_i` is less than or equal to `n`.*);
//@ ensures(*The value of `seats_i` is greater than or equal to 1.*);
//@ ensures(**);
