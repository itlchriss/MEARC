...
//@ ensures(*The input array `stations` is not null.*);
//@ ensures(*The length of the input array `stations` is greater than 0.*);
//@ ensures(*The value of `r` is between 0 and `n - 1`, inclusive.*);
//@ ensures(*The value of `k` is between 0 and 10^9, inclusive.*);
//@ ensures(**);
