...
//@ ensures(*The `skills` array is not null.*);
//@ ensures(*The `people` list is not null.*);
//@ ensures(*The `skills` array and `people` list are not empty.*);
//@ ensures(*The length of `req_skills` is greater than or equal to 1.*);
//@ ensures(*The length of each string in `req_skills` is greater than or equal to 1.*);
//@ ensures(*Each string in `req_skills` consists of lowercase English letters.*);
//@ ensures(*The length of `people` is greater than or equal to 1.*);
//@ ensures(*The length of each list in `people` is greater than or equal to 0.*);
//@ ensures(*The length of each string in each list in `people` is greater than or equal to 1.*);
//@ ensures(*Each string in each list in `people` consists of lowercase English letters.*);
//@ ensures(*Each skill in each list in `people` is a skill in `req_skills`.*);
//@ ensures(**);
