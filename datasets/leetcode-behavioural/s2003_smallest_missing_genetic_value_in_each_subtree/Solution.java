...
//@ ensures(*The length of `parents` and `nums` arrays is the same.*);
//@ ensures(*The length of the `parents` array is at least 2.*);
//@ ensures(*The value of `parents[0]` is -1.*);
//@ ensures(*The values in the `parents` array are within the range of 0 to n-1, where n is the length of the `parents` array.*);
//@ ensures(*The values in the `nums` array are distinct.*);
//@ ensures(*Each value in the `nums` array is within the range of 1 to 10^5.*);
//@ ensures(**);
