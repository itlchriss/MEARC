...
//@ ensures(*The input array `milestones` is not null.*);
//@ ensures(*The length of the input array `milestones` is greater than 0.*);
//@ ensures(*The elements in the input array `milestones` are positive integers.*);
//@ ensures(**);
