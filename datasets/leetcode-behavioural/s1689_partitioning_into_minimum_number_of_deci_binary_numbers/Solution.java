...
//@ ensures(*The input string `n` represents a positive decimal integer.*);
//@ ensures(*The length of `n` is between 1 and 10^5.*);
//@ ensures(*`n` consists of only digits.*);
//@ ensures(*`n` does not contain any leading zeros.*);
//@ ensures(**);
