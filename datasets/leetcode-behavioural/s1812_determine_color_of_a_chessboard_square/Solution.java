...
//@ ensures(*The input string `coordinates` must have a length of 2.*);
//@ ensures(*The first character of `coordinates` must be a letter between 'a' and 'h'.*);
//@ ensures(*The second character of `coordinates` must be a digit between '1' and '8'.*);
//@ ensures(**);
