...
//@ ensures(*The length of the input array `points` must be at least 3.*);
//@ ensures(*The coordinates of each point in the input array `points` must be within the range of -50 to 50.*);
//@ ensures(**);
