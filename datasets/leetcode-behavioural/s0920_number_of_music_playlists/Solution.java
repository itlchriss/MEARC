...
//@ ensures(*The value of `n` must be greater than or equal to - The value of `k` must be greater than or equal to - The value of `n` must be less than or equal to `goal`.*);
//@ ensures(*The value of `k` must be less than `n`.*);
//@ ensures(*The value of `goal` must be less than or equal to *);
