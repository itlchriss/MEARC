...
//@ ensures(*The input array `books` is not null.*);
//@ ensures(*The input array `books` has at least one element.*);
//@ ensures(*The input integer `shelfWidth` is greater than or equal to 1.*);
//@ ensures(*The thickness and height of each book in the input array `books` are greater than or equal to 1.*);
//@ ensures(*The thickness of each book in the input array `books` is less than or equal to `shelfWidth`.*);
//@ ensures(*The height of each book in the input array `books` is less than or equal to 1000.*);
//@ ensures(**);
