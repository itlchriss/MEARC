...
//@ ensures(*The input list `maxHeights` must not be null.*);
//@ ensures(*The length of the input list `maxHeights` must be greater than 0.*);
//@ ensures(*Each element in the input list `maxHeights` must be a positive integer.*);
//@ ensures(**);
