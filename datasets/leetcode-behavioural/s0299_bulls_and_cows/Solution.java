...
//@ ensures(*The string parameter `secret` and the string parameter `guess` must not be null.*);
//@ ensures(*The string parameter `secret` and the string parameter `guess` must consist of digits only.*);
