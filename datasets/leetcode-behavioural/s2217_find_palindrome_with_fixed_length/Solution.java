...
//@ ensures(*The length of the input array `queries` must be greater than or equal to 1.*);
//@ ensures(*The elements in the input array `queries` must be positive integers.*);
//@ ensures(*The input integer `intLength` must be a positive integer.*);
//@ ensures(*The input integer `intLength` must be less than or equal to 15.*);
//@ ensures(**);
