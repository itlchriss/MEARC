...
//@ ensures(*The integers `l` and `r` must be non-negative.*);
//@ ensures(*The integer `l` must be less than or equal to `r`.*);
//@ ensures(*The sum of the elements in `nums` must not exceed 20,000.*);
//@ ensures(**);
