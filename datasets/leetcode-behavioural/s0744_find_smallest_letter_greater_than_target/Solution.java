...
//@ ensures(*1. The `letters` array is not null.*);
//@ ensures(*2. The `letters` array is sorted in non-decreasing order.*);
//@ ensures(*3. The `letters` array contains at least two different characters.*);
//@ ensures(*4. The `target` character is a lowercase English letter.*);
//@ ensures(**);
