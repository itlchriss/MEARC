...
//@ ensures(*The length of the input array `points` is greater than or equal to `k`.*);
//@ ensures(*Each element in the input array `points` is a valid point represented by an array of length 2.*);
