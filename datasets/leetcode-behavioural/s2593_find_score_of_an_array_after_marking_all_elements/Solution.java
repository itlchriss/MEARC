...
//@ ensures(*The length of the input array `nums` is less than or equal to 10^5.*);
//@ ensures(*The values of the elements in the input array `nums` are less than or equal to 10^6.*);
//@ ensures(**);
