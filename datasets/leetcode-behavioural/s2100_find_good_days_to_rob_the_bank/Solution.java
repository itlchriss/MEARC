...
//@ ensures(*The input array `security` is not null.*);
//@ ensures(*The length of the input array `security` is greater than or equal to 1.*);
//@ ensures(*The input integer `time` is greater than or equal to 0.*);
//@ ensures(**);
