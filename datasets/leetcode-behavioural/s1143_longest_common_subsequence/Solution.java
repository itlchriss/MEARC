...
//@ ensures(*The input strings `text1` and `text2` are not null.*);
//@ ensures(*The lengths of `text1` and `text2` are between 1 and 1000, inclusive.*);
//@ ensures(*`text1` and `text2` consist of only lowercase English characters.*);
//@ ensures(**);
