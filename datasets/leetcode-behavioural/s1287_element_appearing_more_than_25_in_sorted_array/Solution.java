...
//@ ensures(*The input array `arr` is sorted in non-decreasing order.*);
//@ ensures(*The length of the input array `arr` is between 1 and 10^4.*);
//@ ensures(*The elements in the input array `arr` are between 0 and 10^5.*);
//@ ensures(**);
