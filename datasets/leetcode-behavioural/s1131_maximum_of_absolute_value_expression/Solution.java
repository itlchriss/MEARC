...
//@ ensures(*The lengths of arr1 and arr2 must be equal.*);
//@ ensures(*The length of arr1 and arr2 must be at least - The elements in arr1 and arr2 must be integers.*);
//@ ensures(*The elements in arr1 and arr2 must be within the range of -10^6 to 10^*);
