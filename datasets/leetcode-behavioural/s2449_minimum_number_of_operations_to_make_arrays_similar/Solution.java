...
//@ ensures(*The input arrays `nums` and `target` are not null.*);
//@ ensures(*The length of `nums` is equal to the length of `target`.*);
//@ ensures(*The length of `nums` is greater than 0.*);
//@ ensures(*The elements of `nums` and `target` are positive integers.*);
//@ ensures(*It is possible to make `nums` similar to `target`.*);
//@ ensures(**);
