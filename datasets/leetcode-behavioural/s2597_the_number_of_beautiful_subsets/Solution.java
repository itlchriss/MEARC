...
//@ ensures(*The input array `nums` contains only positive integers.*);
//@ ensures(*The input integer `k` is positive.*);
//@ ensures(*The length of the input array `nums` is between 1 and 20 (inclusive).*);
//@ ensures(*The values in the input array `nums` are between 1 and 1000 (inclusive).*);
//@ ensures(*The value of `k` is between 1 and 1000 (inclusive).*);
//@ ensures(**);
