...
//@ ensures(*The input integer `threshold` is greater than or equal to the length of the input array `nums`.*);
//@ ensures(*The input integer `threshold` is a positive integer.*);
//@ ensures(**);
