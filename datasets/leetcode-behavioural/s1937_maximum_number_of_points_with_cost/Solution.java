...
//@ ensures(*The input matrix `points` is not null.*);
//@ ensures(*The input matrix `points` has at least one row and one column.*);
//@ ensures(*The input matrix `points` has a maximum size of 10^5 rows and columns.*);
//@ ensures(*The values in the input matrix `points` are non-negative integers.*);
//@ ensures(**);
