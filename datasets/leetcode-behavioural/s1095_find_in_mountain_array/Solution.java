...
//@ ensures(*The length of the mountain array must be at least 3.*);
//@ ensures(*The target value must be between 0 and 10^9 (inclusive).*);
//@ ensures(*The values in the mountain array must be between 0 and 10^9 (inclusive).*);
//@ ensures(**);
