...
//@ ensures(*The character matrix parameter `matrix` must not be null.*);
//@ ensures(*The integer result is the area of the largest rectangle containing only '1's in the character matrix parameter `matrix`.*);
