...
//@ ensures(*The input array `skill` is not null.*);
//@ ensures(*The length of the input array `skill` is even.*);
//@ ensures(*The length of the input array `skill` is greater than or equal to 2.*);
//@ ensures(*Each element in the input array `skill` is a positive integer.*);
//@ ensures(*Each element in the input array `skill` is less than or equal to 1000.*);
//@ ensures(**);
