...
//@ ensures(*The input string `text` is not null.*);
//@ ensures(*The input string `text` is not empty.*);
//@ ensures(*The input string `text` consists only of lowercase English characters.*);
//@ ensures(**);
