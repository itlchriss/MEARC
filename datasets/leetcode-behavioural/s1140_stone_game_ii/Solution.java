...
//@ ensures(*The length of the input array `piles` is greater than or equal to 1.*);
//@ ensures(*The length of the input array `piles` is less than or equal to 100.*);
//@ ensures(*Each element in the input array `piles` is a positive integer.*);
//@ ensures(*The value of `M` is initially set to 1.*);
//@ ensures(**);
