...
//@ ensures(*The length of the `cost` array must be 9.*);
//@ ensures(*Each element in the `cost` array must be a positive integer.*);
//@ ensures(*The `target` value must be a positive integer.*);
//@ ensures(**);
