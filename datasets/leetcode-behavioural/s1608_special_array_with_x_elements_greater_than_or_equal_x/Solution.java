...
//@ ensures(*The length of the input array `nums` is between 1 and 100 (inclusive).*);
//@ ensures(*Each element in the input array `nums` is a non-negative integer between 0 and 1000 (inclusive).*);
//@ ensures(**);
