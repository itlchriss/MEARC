...
//@ ensures(*1. The `board` is a 2D array of size 8x8.*);
//@ ensures(*2. The `board` contains only the characters '.', 'W', and 'B'.*);
//@ ensures(*3. The cell `(rMove, cMove)` on the `board` is currently empty (contains '.').*);
//@ ensures(**);
