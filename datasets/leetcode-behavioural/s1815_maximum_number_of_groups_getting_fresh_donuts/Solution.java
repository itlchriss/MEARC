...
//@ ensures(*The `batchSize` must be a positive integer between 1 and 9.*);
//@ ensures(*The `groups` array must have a length between 1 and 30.*);
//@ ensures(*Each element in the `groups` array must be a positive integer between 1 and 10^9.*);
//@ ensures(**);
