...
//@ ensures(*The input array `rolls` is not null.*);
//@ ensures(*The length of the input array `rolls` is greater than or equal to 1.*);
//@ ensures(*The input integer `k` is greater than or equal to 1.*);
//@ ensures(*The input integer `k` is less than or equal to 10^5.*);
//@ ensures(*Each element in the input array `rolls` is greater than or equal to 1.*);
//@ ensures(*Each element in the input array `rolls` is less than or equal to `k`.*);
//@ ensures(**);
