...
//@ ensures(*The elements of the input array `nums` are either 0 or 1.*);
//@ ensures(*The input integer `goal` is non-negative.*);
//@ ensures(*The input integer `goal` is less than or equal to the length of the input array `nums`.*);
//@ ensures(**);
