...
//@ ensures(*The input `p` is a positive integer.*);
//@ ensures(*The array `nums` is 1-indexed.*);
//@ ensures(*The elements of `nums` are integers in the inclusive range [1, 2^p - 1].*);
//@ ensures(*The length of `nums` is 2^p - 1.*);
//@ ensures(**);
