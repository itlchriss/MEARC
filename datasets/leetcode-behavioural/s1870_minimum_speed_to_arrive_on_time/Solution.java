...
//@ ensures(*The length of the input array `dist` must be equal to the number of train rides `n`.*);
//@ ensures(*The number of train rides `n` must be greater than or equal to 1.*);
//@ ensures(*The distance of each train ride `dist[i]` must be greater than or equal to 1.*);
//@ ensures(*The input `hour` must be greater than or equal to 1.*);
//@ ensures(*The input `hour` must have at most two digits after the decimal point.*);
//@ ensures(**);
