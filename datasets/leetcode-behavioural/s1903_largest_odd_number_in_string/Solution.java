...
//@ ensures(*The input string `num` is not null.*);
//@ ensures(*The input string `num` is not empty.*);
//@ ensures(*The input string `num` consists only of digits.*);
//@ ensures(*The input string `num` does not contain any leading zeros.*);
//@ ensures(**);
