...
//@ ensures(*1. The input `n` must be a positive integer greater than or equal to 1.*);
//@ ensures(*2. The input `start` must be a non-negative integer.*);
//@ ensures(*3. The length of the array `nums` must be equal to `n`.*);
//@ ensures(**);
