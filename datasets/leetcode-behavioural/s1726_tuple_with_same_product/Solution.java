...
//@ ensures(*The length of the input array `nums` is greater than or equal to - All elements in the input array `nums` are distinct positive integers.*);
//@ ensures(*The maximum value of the elements in the input array `nums` is less than or equal to 10^*);
