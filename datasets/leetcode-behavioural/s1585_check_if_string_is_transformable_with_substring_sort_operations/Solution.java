...
//@ ensures(*The lengths of strings `s` and `t` are equal.*);
//@ ensures(*The lengths of strings `s` and `t` are between 1 and 10^5.*);
//@ ensures(*Strings `s` and `t` consist of only digits.*);
//@ ensures(**);
