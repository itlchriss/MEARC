...
//@ ensures(*The input integers `n` and `x` must be positive.*);
//@ ensures(*The value of `n` must be between 1 and 300 (inclusive).*);
//@ ensures(*The value of `x` must be between 1 and 5 (inclusive).*);
//@ ensures(**);
