...
//@ ensures(*2. The input string `s` is not empty.*);
//@ ensures(*3. The input integer `k` is greater than or equal to 2.*);
//@ ensures(*4. The input integer `k` is less than or equal to 10,000.*);
//@ ensures(*5. The input string `s` only contains lower case English letters.*);
//@ ensures(**);
