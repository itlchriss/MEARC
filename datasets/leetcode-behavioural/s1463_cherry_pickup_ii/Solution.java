...
//@ ensures(*The number of rows and columns in the grid must be between 2 and 70 (inclusive).*);
//@ ensures(*The values in the grid must be between 0 and 100 (inclusive).*);
//@ ensures(**);
