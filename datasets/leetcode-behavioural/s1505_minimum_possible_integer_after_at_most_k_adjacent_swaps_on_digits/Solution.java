...
//@ ensures(*1. The input string `num` must not be null.*);
//@ ensures(*2. The input string `num` must not be empty.*);
//@ ensures(*3. The input string `num` must consist of only digits.*);
//@ ensures(*4. The input string `num` must not contain leading zeros.*);
//@ ensures(*5. The input integer `k` must be greater than or equal to 1.*);
//@ ensures(*6. The input integer `k` must be less than or equal to 10^4.*);
//@ ensures(**);
