...
//@ ensures(*If the string parameter `s` is "*", the integer result is 9.*);
//@ ensures(*If the string parameter `s` is "1*", the integer result is 18.*);
//@ ensures(*If the string parameter `s` is "2*", the integer result is 15.*);
