...
//@ ensures(*The input array `row` is not null.*);
//@ ensures(*The length of the input array `row` is even.*);
//@ ensures(*The elements of the input array `row` are unique.*);
//@ ensures(*The elements of the input array `row` are integers.*);
//@ ensures(*The elements of the input array `row` are non-negative.*);
//@ ensures(*The elements of the input array `row` are less than twice the length of the array.*);
//@ ensures(**);
