...
//@ ensures(*The length of the input array `nums` is greater than or equal to - The input integer `k` is greater than or equal to - The elements in the input array `nums` are non-negative integers.*);
//@ ensures(*The elements in the input array `nums` are less than or equal to 10^*);
