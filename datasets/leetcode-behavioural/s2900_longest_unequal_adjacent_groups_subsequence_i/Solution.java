...
//@ ensures(*The length of the `words` array must be equal to `n`.*);
//@ ensures(*The length of the `groups` array must be equal to `n`.*);
//@ ensures(*Each element in the `groups` array must be either 0 or 1.*);
//@ ensures(*The `words` array must consist of distinct strings.*);
//@ ensures(*Each string in the `words` array must consist of lowercase English letters.*);
//@ ensures(**);
