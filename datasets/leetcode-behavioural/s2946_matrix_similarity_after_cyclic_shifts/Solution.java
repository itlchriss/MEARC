...
//@ ensures(*The length of `mat` is greater than or equal to 1 and less than or equal to 25.*);
//@ ensures(*The length of each row in `mat` is greater than or equal to 1 and less than or equal to 25.*);
//@ ensures(*Each element in `mat` is an integer greater than or equal to 1 and less than or equal to 25.*);
//@ ensures(*The value of `k` is greater than or equal to 1 and less than or equal to 50.*);
//@ ensures(**);
