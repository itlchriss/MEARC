...
//@ ensures(*The integer matrix parameter `mat` must not be null.*);
//@ ensures(*The integer array result contains all elements of the integer matrix parameter `mat` in a diagonal order.*);
