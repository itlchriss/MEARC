...
//@ ensures(*The input array `groupSizes` is not null.*);
//@ ensures(*The length of `groupSizes` is equal to `n`.*);
//@ ensures(*Each element in `groupSizes` is a positive integer.*);
//@ ensures(*The sum of all elements in `groupSizes` is equal to `n`.*);
//@ ensures(**);
