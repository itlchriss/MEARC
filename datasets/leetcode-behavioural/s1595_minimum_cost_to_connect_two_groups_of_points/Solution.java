...
//@ ensures(*1. The input `cost` is a non-empty list of lists.*);
//@ ensures(*2. The length of `cost` is equal to `size1`.*);
//@ ensures(*3. Each sublist in `cost` has a length equal to `size2`.*);
//@ ensures(*4. `size1` is greater than or equal to `size2`.*);
//@ ensures(*5. The values in `cost` are non-negative integers.*);
//@ ensures(*6. The values in `cost` are less than or equal to 100.*);
//@ ensures(**);
