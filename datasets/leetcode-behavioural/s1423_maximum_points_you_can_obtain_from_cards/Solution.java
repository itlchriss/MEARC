...
//@ ensures(*The input array `cardPoints` is not null.*);
//@ ensures(*The length of the input array `cardPoints` is greater than or equal to 1.*);
//@ ensures(*The input integer `k` is greater than or equal to 1.*);
//@ ensures(*The input integer `k` is less than or equal to the length of the input array `cardPoints`.*);
//@ ensures(**);
