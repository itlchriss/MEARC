...
//@ ensures(*The length of `chargeTimes` and `runningCosts` arrays must be equal to `n`.*);
//@ ensures(*The length of `chargeTimes` and `runningCosts` arrays must be greater than 0.*);
//@ ensures(*The elements in `chargeTimes` and `runningCosts` arrays must be positive integers.*);
//@ ensures(*The value of `budget` must be a positive integer.*);
//@ ensures(**);
