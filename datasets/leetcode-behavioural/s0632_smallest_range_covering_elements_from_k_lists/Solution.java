...
//@ ensures(*The integer parameter `obj` must not be null.*);
//@ ensures(*The integer result is the comparison result of the current Triplet object with the Triplet object `obj`.*);
