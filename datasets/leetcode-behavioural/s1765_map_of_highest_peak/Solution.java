...
//@ ensures(*The input matrix `isWater` is not null.*);
//@ ensures(*The dimensions of the input matrix `isWater` are valid (1 <= m, n <= 1000).*);
//@ ensures(*There is at least one water cell in the input matrix `isWater`.*);
//@ ensures(**);
