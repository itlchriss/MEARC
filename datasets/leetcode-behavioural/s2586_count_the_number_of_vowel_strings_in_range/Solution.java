...
//@ ensures(*The integers `left` and `right` are valid indices within the range of the `words` array.*);
//@ ensures(*The strings in the `words` array consist of only lowercase English letters.*);
//@ ensures(**);
