...
//@ ensures(*The input integer `n` must be greater than or equal to 2.*);
//@ ensures(*The length of the input array `sick` must be greater than or equal to 1.*);
//@ ensures(*The elements in the input array `sick` must be in the range from 0 to `n - 1`.*);
//@ ensures(*The input array `sick` must be sorted in increasing order.*);
//@ ensures(**);
