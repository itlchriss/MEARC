...
//@ ensures(*The input integers `n`, `m`, and `k` must be valid and within the specified constraints.*);
//@ ensures(*`n` must be greater than or equal to - `m` must be greater than or equal to - `k` must be greater than or equal to 0 and less than or equal to `n`.*);
//@ ensures(**);
