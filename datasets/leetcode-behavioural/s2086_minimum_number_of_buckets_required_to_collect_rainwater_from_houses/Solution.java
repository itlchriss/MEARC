...
//@ ensures(*The input string `street` is not null.*);
//@ ensures(*The length of the input string `street` is greater than or equal to 1.*);
//@ ensures(*Each character in the input string `street` is either 'H' or '.'.*);
//@ ensures(**);
