...
//@ ensures(*The string parameter `text` and `text2` must not be null.*);
//@ ensures(*The integer result is the number of distinct subsequences of the string parameter `text` which equals the string parameter `text2`.*);
