...
//@ ensures(*The length of the input array `values` is at least 2.*);
//@ ensures(*The values in the input array `values` are positive integers.*);
//@ ensures(*The values in the input array `values` are not greater than 1000.*);
//@ ensures(**);
