...
//@ ensures(*The input array `pref` is not null.*);
//@ ensures(*The length of the input array `pref` is greater than or equal to - The elements of the input array `pref` are non-negative integers.*);
//@ ensures(**);
