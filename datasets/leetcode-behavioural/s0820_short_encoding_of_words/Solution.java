...
//@ ensures(*Each element in the input array `words` is not null.*);
//@ ensures(*Each element in the input array `words` is a string consisting of only lowercase letters.*);
//@ ensures(**);
