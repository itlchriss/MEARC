...
//@ ensures(*The input array `digits` must not be null.*);
//@ ensures(*The length of the input array `digits` must be between 1 and 10,000 (inclusive).*);
//@ ensures(*Each element in the input array `digits` must be an integer between 0 and 9 (inclusive).*);
//@ ensures(**);
