...
//@ ensures(*The length of the input array `nums` must be greater than or equal to - The elements in the input array `nums` must be integers.*);
//@ ensures(*The value of `k` must be greater than or equal to *);
