...
//@ ensures(*The input string `num` must have a length greater than or equal to 1 and less than or equal to 3500.*);
//@ ensures(*The characters in the input string `num` must be digits from '0' to '9'.*);
//@ ensures(**);
