...
//@ ensures(*The size of the list of lists result is equal to 2 to the power of the length of the integer array parameter `nums`.*);
//@ ensures(*The list of lists result must not contain any duplicate subsets.*);
