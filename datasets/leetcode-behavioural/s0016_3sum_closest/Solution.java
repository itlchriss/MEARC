...
//@ ensures(*The integer result is the sum of three integers in the integer array parameter `nums` that is closest to the integer parameter `target`.*);
//@ ensures(*The sum of the three integers in the integer array parameter `nums` must be calculated such that it is closest to the integer parameter `target`.*);
