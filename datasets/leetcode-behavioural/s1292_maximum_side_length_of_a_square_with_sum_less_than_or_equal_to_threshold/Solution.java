...
//@ ensures(*3. The input matrix `mat` has dimensions `m x n`, where `m` is the number of rows and `n` is the number of columns.*);
//@ ensures(*4. The elements of the input matrix `mat` are non-negative integers.*);
//@ ensures(*5. The input threshold is a non-negative integer.*);
//@ ensures(**);
