...
//@ ensures(*The length of `num` must be between 1 and 100 (inclusive).*);
//@ ensures(*`num` must only consist of digits '0' through '9'.*);
//@ ensures(*`num` must not contain any leading zeros.*);
//@ ensures(**);
