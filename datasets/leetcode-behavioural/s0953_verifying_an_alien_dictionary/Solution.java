...
//@ ensures(*The `words` array is not null.*);
//@ ensures(*The `order` string is not null.*);
//@ ensures(*The length of the `words` array is greater than or equal to 1.*);
//@ ensures(*The length of each word in the `words` array is greater than or equal to 1.*);
//@ ensures(*The length of the `order` string is equal to 26.*);
//@ ensures(*All characters in each word of the `words` array and in the `order` string are English lowercase letters.*);
//@ ensures(**);
