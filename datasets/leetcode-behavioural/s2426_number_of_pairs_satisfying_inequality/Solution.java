...
//@ ensures(*The length `n` of the input arrays must be at least 2.*);
//@ ensures(*The elements of `nums1` and `nums2` must be integers.*);
//@ ensures(*The value of `diff` must be an integer.*);
//@ ensures(**);
