...
//@ ensures(*The input strings `a`, `b`, and `c` are not null.*);
//@ ensures(*The lengths of `a`, `b`, and `c` are between 1 and 100 (inclusive).*);
//@ ensures(*`a`, `b`, and `c` consist only of lowercase English letters.*);
//@ ensures(**);
