...
//@ ensures(*The input array `colors` is not null.*);
//@ ensures(*The length of the input array `colors` is greater than or equal to 2.*);
//@ ensures(*The elements of the input array `colors` are integers.*);
//@ ensures(*The elements of the input array `colors` are within the range of 0 to 100.*);
//@ ensures(**);
